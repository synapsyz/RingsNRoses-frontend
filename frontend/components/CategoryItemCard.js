    ...
    <div key={item.id} className="h-full flex flex-col">
      <div className="group relative">
        <a href={item.detail_url} className="block relative w-full h-48 md:h-64 overflow-hidden rounded-xl">
          <img
            src={item.thumbnail_url || 'https://i0.wp.com/suessmoments.com/wp-content/uploads/sites/10014/2023/02/website-shadowbrook-nj-wedding-photos-7153-photography-by-SUESS-MOMENTS.jpg?ssl=1'}
            alt={item.name}
