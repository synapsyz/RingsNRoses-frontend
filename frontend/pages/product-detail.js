...
export default function ProductPage() {
  ...
  const text = `VM Grand Mahal is a prominent banquet hall located near Madambakkam in Chennai. 
It's an ideal location to host a wide range of your wedding functions, from mehndi and sangeet to receptions. 
Selecting a suitable event space is essential to organising a perfect wedding ceremony, and it should be chosen 
to keep in mind your budget, accessibility and suitability. Therefore, if you are looking for a place that offers 
impeccable service with warm hospitality, the VM Grand Mahal is the choice that you should make. VM Grand Mahal is 
an excellent venue and is a great fit to organise all your nuptial ceremonies grandly. The team of professionals 
takes care of every setup and ensures that you get the perfect nuptial experience of your life, which you can keep 
in your heart permanently.`;
  ...
  return (
    <>
      <Head>
        ...
        <meta name="twitter:title" content="Shop Product Detail | Preline Pro | Preline UI, crafted with Tailwind CSS" />
        ...
        <meta property="og:title" content="Shop Product Detail | Preline Pro | Preline UI, crafted with Tailwind CSS" />
        ...
        {/* Title */}
        <title>Shop Product Detail | Preline Pro | Preline UI, crafted with Tailwind CSS</title>
...
<div id="mega-menu-catalog-tab-6" class="hidden h-full" role="tabpanel" aria-labelledby="mega-menu-catalog-tab-item-6">
  ...
  <main id="content">
    ...
    <div class="w-full max-w-[85rem] px-4 sm:px-6 lg:px-8 mx-auto">
      <div class="pt-6">
        <div class="-ms-1.5 pb-3">
          {/* <!-- Breadcrumb --> */}
          <ol class=" flex items-center whitespace-nowrap">
            <li class="flex items-center">

              <a class="py-0.5 px-1.5 flex items-center gap-x-1 text-sm rounded-md text-gray-600 hover:bg-gray-100 focus:bg-gray-100 focus:outline-hidden dark:text-neutral-400 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800" href="listing.html">
                Venues
              </a>
            ...
            <li class="flex items-center truncate">
              ...
              <a class="py-0.5 px-1.5 flex items-center truncate gap-x-1 text-sm truncate rounded-md text-gray-600 hover:bg-gray-100 focus:bg-gray-100 focus:outline-hidden dark:text-neutral-400 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800" href="listing.html">
                <span class="truncate">Mahals</span>
              </a>
              <svg class="shrink-0 overflow-visible size-4  text-gray-400 dark:text-neutral-600" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                <path d="M6 13L10 3" stroke="currentColor" stroke-linecap="round"></path>
              </svg>
            ...
            <li class="ps-1.5 flex items-center truncate font-semibold text-gray-800 dark:text-neutral-200 text-sm truncate">
              <span class="truncate">VM Garden Mahal</span>
            </li>
          </ol>
          {/* <!-- End Breadcrumb --> */}
        </div>
        ...
        {/* <!-- Grid --> */}
        <div class="grid grid-cols-1 lg:grid-cols-5 gap-y-10">
          <div class="lg:col-span-3">
            ...
            <div data-hs-carousel='{
              ...
              <div class="hs-carousel flex flex-col sm:flex-row gap-3 sm:gap-5">
                {/* <!-- Thumbnails --> */}
                <div class="flex-none order-2 sm:order-1">
                  <div class="hs-carousel-pagination sm:h-175 flex flex-row sm:flex-col gap-3 pb-1.5 sm:pb-0 overflow-x-auto sm:overflow-x-hidden sm:overflow-y-auto [&::-webkit-scrollbar]:h-1 sm:[&::-webkit-scrollbar]:hidden [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500">
                    <div class="hs-carousel-pagination-item relative shrink-0 size-20 rounded-md sm:rounded-lg overflow-hidden cursor-pointer after:absolute after:inset-0 after:size-full after:rounded-md sm:after:rounded-lg border border-gray-200 hs-carousel-active:border-gray-800 hs-carousel-active:after:bg-black/10 dark:hs-carousel-active:border-white dark:border-neutral-700">
                      <img class="bg-gray-100 size-full object-cover rounded-md sm:rounded-lg dark:bg-neutral-800" src="https://cdn0.weddingwire.in/vendor/6050/3_2/960/jpg/pic00969_15_436050-168574165457016.webp" alt="Product Image"/>
                    </div>
                    <div class="hs-carousel-pagination-item relative shrink-0 size-20 rounded-md sm:rounded-lg overflow-hidden cursor-pointer after:absolute after:inset-0 after:size-full after:rounded-md sm:after:rounded-lg border border-gray-200 hs-carousel-active:border-gray-800 hs-carousel-active:after:bg-black/10 dark:hs-carousel-active:border-white dark:border-neutral-700">
                      <img class="bg-gray-100 size-full object-cover rounded-md sm:rounded-lg dark:bg-neutral-800" src="https://cdn0.weddingwire.in/vendor/6050/3_2/960/jpg/banquet-halls-vm-grand-mahal-event-space-2_15_436050-167403629310495.webp" alt="Product Image"/>
                    </div>
                    <div class="hs-carousel-pagination-item relative shrink-0 size-20 rounded-md sm:rounded-lg overflow-hidden cursor-pointer after:absolute after:inset-0 after:size-full after:rounded-md sm:after:rounded-lg border border-gray-200 hs-carousel-active:border-gray-800 hs-carousel-active:after:bg-black/10 dark:hs-carousel-active:border-white dark:border-neutral-700">
                      <img class="bg-gray-100 size-full object-cover rounded-md sm:rounded-lg dark:bg-neutral-800" src="https://cdn0.weddingwire.in/vendor/6050/3_2/960/jpg/banquet-halls-vm-grand-mahal-event-space-1_15_436050-167403627731052.webp" alt="Product Image"/>
                    </div>
                    <div class="hs-carousel-pagination-item relative shrink-0 size-20 rounded-md sm:rounded-lg overflow-hidden cursor-pointer after:absolute after:inset-0 after:size-full after:rounded-md sm:after:rounded-lg border border-gray-200 hs-carousel-active:border-gray-800 hs-carousel-active:after:bg-black/10 dark:hs-carousel-active:border-white dark:border-neutral-700">
                      <img class="bg-gray-100 size-full object-cover rounded-md sm:rounded-lg dark:bg-neutral-800" src="https://cdn0.weddingwire.in/vendor/6050/3_2/960/jpeg/banquet-halls-vm-grand-mahal-event-space-1_15_436050-167403626572101.webp" alt="Product Image"/>
                    </div>
                    <div class="hs-carousel-pagination-item relative shrink-0 size-20 rounded-md sm:rounded-lg overflow-hidden cursor-pointer after:absolute after:inset-0 after:size-full after:rounded-md sm:after:rounded-lg border border-gray-200 hs-carousel-active:border-gray-800 hs-carousel-active:after:bg-black/10 dark:hs-carousel-active:border-white dark:border-neutral-700">
                      <img class="bg-gray-100 size-full object-cover rounded-md sm:rounded-lg dark:bg-neutral-800" src="https://cdn0.weddingwire.in/vendor/6050/3_2/1280/jpg/pic00937-dining_15_436050-167599220426128.webp" alt="Product Image"/>
                    </div>
                    <div class="hs-carousel-pagination-item relative shrink-0 size-20 rounded-md sm:rounded-lg overflow-hidden cursor-pointer after:absolute after:inset-0 after:size-full after:rounded-md sm:after:rounded-lg border border-gray-200 hs-carousel-active:border-gray-800 hs-carousel-active:after:bg-black/10 dark:hs-carousel-active:border-white dark:border-neutral-700">
                      <img class="bg-gray-100 size-full object-cover rounded-md sm:rounded-lg dark:bg-neutral-800" src="https://cdn0.weddingwire.in/vendor/6050/3_2/960/jpeg/whatsapp-image-2023-06-06-at-8-12-26-pm-1_15_436050-168645021291994.webp" alt="Product Image"/>
                    </div>
                    <div class="hs-carousel-pagination-item relative shrink-0 size-20 rounded-md sm:rounded-lg overflow-hidden cursor-pointer after:absolute after:inset-0 after:size-full after:rounded-md sm:after:rounded-lg border border-gray-200 hs-carousel-active:border-gray-800 hs-carousel-active:after:bg-black/10 dark:hs-carousel-active:border-white dark:border-neutral-700">
                      <img class="bg-gray-100 size-full object-cover rounded-md sm:rounded-lg dark:bg-neutral-800" src="https://cdn0.weddingwire.in/vendor/6050/3_2/1280/jpg/502a4531_15_436050-168645021732047.webp" alt="Product Image"/>
                    </div>
                    <div class="hs-carousel-pagination-item relative shrink-0 size-20 rounded-md sm:rounded-lg overflow-hidden cursor-pointer after:absolute after:inset-0 after:size-full after:rounded-md sm:after:rounded-lg border border-gray-200 hs-carousel-active:border-gray-800 hs-carousel-active:after:bg-black/10 dark:hs-carousel-active:border-white dark:border-neutral-700">
                      <img class="bg-gray-100 size-full object-cover rounded-md sm:rounded-lg dark:bg-neutral-800" src="https://cdn0.weddingwire.in/vendor/6050/3_2/960/jpeg/banquet-halls-vm-grand-mahal-event-space-1_15_436050-167403626572101.webp" alt="Product Image"/>
                    </div>
                    <div class="hs-carousel-pagination-item relative shrink-0 size-20 rounded-md sm:rounded-lg overflow-hidden cursor-pointer after:absolute after:inset-0 after:size-full after:rounded-md sm:after:rounded-lg border border-gray-200 hs-carousel-active:border-gray-800 hs-carousel-active:after:bg-black/10 dark:hs-carousel-active:border-white dark:border-neutral-700">
                      <img class="bg-gray-100 size-full object-cover rounded-md sm:rounded-lg dark:bg-neutral-800" src="https://cdn0.weddingwire.in/vendor/6050/original/960/jpg/pic00911-ganesh_15_436050-167599229237042.webp" alt="Product Image"/>
                    </div>
                    <div class="hs-carousel-pagination-item relative shrink-0 size-20 rounded-md sm:rounded-lg overflow-hidden cursor-pointer after:absolute after:inset-0 after:size-full after:rounded-md sm:after:rounded-lg border border-gray-200 hs-carousel-active:border-gray-800 hs-carousel-active:after:bg-black/10 dark:hs-carousel-active:border-white dark:border-neutral-700">
                      <img class="bg-gray-100 size-full object-cover rounded-md sm:rounded-lg dark:bg-neutral-800" src="https://cdn0.weddingwire.in/vendor/6050/3_2/960/jpg/banquet-halls-vm-grand-mahal-event-space-3_15_436050-167403630555271.webp" alt="Product Image"/>
                    </div>
                  </div>
                </div>
                {/* <!-- End Thumbnails --> */}
                ...
                {/* <!-- Preview --> */}
                <div class="relative group grow overflow-hidden h-137.5 sm:h-175 order-1 sm:order-2 bg-gray-100 rounded-lg dark:bg-neutral-800">
                  <div class="hs-carousel-body absolute inset-y-0 start-0 flex flex-nowrap opacity-0">
                    <div class="hs-carousel-slide">
                      <img class="bg-gray-100 size-full object-cover rounded-lg dark:bg-neutral-800" src="https://cdn0.weddingwire.in/vendor/6050/3_2/960/jpg/pic00969_15_436050-168574165457016.webp" alt="Product Image"/>
                    </div>
                    <div class="hs-carousel-slide">
                      <img class="bg-gray-100 size-full object-cover rounded-lg dark:bg-neutral-800" src="https://cdn0.weddingwire.in/vendor/6050/3_2/960/jpg/banquet-halls-vm-grand-mahal-event-space-2_15_436050-167403629310495.webp" alt="Product Image"/>
                    </div>
                    <div class="hs-carousel-slide">
                      <img class="bg-gray-100 size-full object-cover rounded-lg dark:bg-neutral-800" src="https://cdn0.weddingwire.in/vendor/6050/3_2/960/jpg/banquet-halls-vm-grand-mahal-event-space-1_15_436050-167403627731052.webp" alt="Product Image"/>
                    </div>
                    <div class="hs-carousel-slide">
                      <img class="bg-gray-100 size-full object-cover rounded-lg dark:bg-neutral-800" src="https://cdn0.weddingwire.in/vendor/6050/3_2/960/jpeg/banquet-halls-vm-grand-mahal-event-space-1_15_436050-167403626572101.webp" alt="Product Image"/>
                    </div>
                    <div class="hs-carousel-slide">
                      <img class="bg-gray-100 size-full object-cover rounded-lg dark:bg-neutral-800" src="https://cdn0.weddingwire.in/vendor/6050/3_2/1280/jpg/pic00937-dining_15_436050-167599220426128.webp" alt="Product Image"/>
                    </div>
                    <div class="hs-carousel-slide">
                      <img class="bg-gray-100 size-full object-cover rounded-lg dark:bg-neutral-800" src="https://cdn0.weddingwire.in/vendor/6050/3_2/960/jpeg/whatsapp-image-2023-06-06-at-8-12-26-pm-1_15_436050-168645021291994.webp" alt="Product Image"/>
                    </div>
                    <div class="hs-carousel-slide">
                      <img class="bg-gray-100 size-full object-cover rounded-lg dark:bg-neutral-800" src="https://cdn0.weddingwire.in/vendor/6050/3_2/1280/jpg/502a4531_15_436050-168645021732047.webp" alt="Product Image"/>
                    </div>
                    <div class="hs-carousel-slide">
                      <img class="bg-gray-100 size-full object-cover rounded-lg dark:bg-neutral-800" src="https://cdn0.weddingwire.in/vendor/6050/3_2/960/jpeg/banquet-halls-vm-grand-mahal-event-space-1_15_436050-167403626572101.webp" alt="Product Image"/>
                    </div>
                    <div class="hs-carousel-slide">
                      <img class="bg-gray-100 size-full object-cover rounded-lg dark:bg-neutral-800" src="https://cdn0.weddingwire.in/vendor/6050/original/960/jpg/pic00911-ganesh_15_436050-167599229237042.webp" alt="Product Image"/>
                    </div>
                    <div class="hs-carousel-slide">
                      <img class="bg-gray-100 size-full object-cover rounded-lg dark:bg-neutral-800" src="https://cdn0.weddingwire.in/vendor/6050/3_2/960/jpg/banquet-halls-vm-grand-mahal-event-space-3_15_436050-167403630555271.webp" alt="Product Image"/>
                    </div>
                  </div>

                  {/* <!-- Nav --> */}
                  <button type="button" class="hs-carousel-prev group-hover:opacity-100 opacity-0 absolute top-1/2 start-2 inline-flex justify-center items-center size-10 bg-white border border-gray-100 text-gray-800 rounded-full shadow-2xs hover:bg-gray-100 -translate-y-1/2 focus:outline-hidden">
                  ...
                  <button type="button" class="hs-carousel-next group-hover:opacity-100 opacity-0 absolute top-1/2 end-2 inline-flex justify-center items-center size-10 bg-white border border-gray-100 text-gray-800 rounded-full shadow-2xs hover:bg-gray-100 -translate-y-1/2 focus:outline-hidden">
            ...
            <div class="pt-10">
              {/* <!-- Reviews --> */}
              <div id="reviews" class="flex flex-wrap justify-between items-center gap-3">
              ...
              <div id="hs-pro-reviews-tabs-scroll" class="relative py-3 overflow-hidden" data-hs-scroll-nav>
                {/* <!-- Nav Tab --> */}
                <nav id="hs-pro-reviews-tabs" class="hs-scroll-nav-body flex gap-1 snap-x snap-mandatory overflow-x-auto [&::-webkit-scrollbar]:h-0 p-0.5 bg-white border border-gray-200 rounded-full dark:bg-neutral-900 dark:border-neutral-700" aria-label="Tabs" role="tablist" aria-orientation="horizontal">
                  <button type="button" class="hs-tab-active:bg-gray-200 snap-start hs-tab-active:bg-gray-100 hs-tab-active:focus:bg-gray-100 hs-tab-active:focus:text-gray-800 w-full inline-flex justify-center items-center gap-x-2 text-gray-800 py-2 px-3 text-sm whitespace-nowrap rounded-full disabled:opacity-50 disabled:pointer-events-none focus:outline-hidden focus:text-gray-500 dark:hs-tab-active:bg-neutral-800 dark:focus:hs-tab-active:bg-neutral-800 dark:focus:hs-tab-active:text-neutral-200 dark:text-neutral-200 dark:focus:text-neutral-400 disabled:opacity-50 disabled:pointer-events-none focus:outline-hidden active" id="hs-pro-tabs-shpm-item-five-star" aria-selected="true" data-hs-tab="#hs-pro-tabs-shpm-five-star" aria-controls="hs-pro-tabs-shpm-five-star" role="tab">
                    5 star (100)
                  </button>
              ...
              <div id="hs-pro-tabs-shpm-five-star" role="tabpanel" aria-labelledby="hs-pro-tabs-shpm-item-five-star">
                ...
                <div class="grid sm:grid-cols-2 gap-4">
                  {/* <!-- Review --> */}
                  <div class="p-4 h-full flex flex-col bg-white border border-gray-200 rounded-xl shadow-2xs dark:bg-neutral-900 dark:border-neutral-700">
                    <div class="flex flex-wrap justify-between gap-3">
                      <div>
                        <h6 class="font-semibold text-sm text-gray-800 dark:text-neutral-200">
                          Ramaswami
                        </h6>
                      ...
                      <div class="mt-1">
                        ...
                        <div class="flex items-center gap-x-0.5">
                          <svg class="shrink-0 size-3.5 text-emerald-600 dark:text-emerald-400" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                            <path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z"></path>
                          </svg>
                          <svg class="shrink-0 size-3.5 text-emerald-600 dark:text-emerald-400" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                            <path d="M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z"></path>
                    ...
                    <div>
                      <div class="mt-3 flex gap-2">
                        <img class="shrink-0 size-20 bg-gray-100 rounded-lg dark:bg-neutral-800" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSBcOgnYwsopYJJQ7TFYWA_TmI-JtY84q12sg&s" alt="Review Image"/>
                        <img class="shrink-0 size-20 bg-gray-100 rounded-lg dark:bg-neutral-800" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS0WrbOeeES3K05eDi2aS_gtnjgSamCCx7leA&s" alt="Review Image"/>
                        <img class="shrink-0 size-20 bg-gray-100 rounded-lg dark:bg-neutral-800" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRt1tsb2kodof5S_jy2VXzcMdt7VRcdJ7ffaQ&s" alt="Review Image"/>
                      </div>
...
We recently rented VM Grand Mahal for a family function, and I must say, it exceeded all our expectations. The hall is spacious, well-maintained, and beautifully designed, making it ideal for large gatherings. The air conditioning was perfect, and the lighting setup added a great ambiance to the event.                    </div>
                  ...
                  <div class="p-4 h-full flex flex-col bg-white border border-gray-200 rounded-xl shadow-2xs dark:bg-neutral-900 dark:border-neutral-700">
                    ...
                    <div>
                      <div class="mt-3 flex gap-2">
                        <img class="shrink-0 size-20 bg-gray-100 rounded-lg dark:bg-neutral-800" src="https://image.wedmegood.com/resized/720X/uploads/member/3905993/1686526219_WhatsApp_Image_2023_06_09_at_12.11.12_AM.jpeg" alt="Review Image"/>
                        <img class="shrink-0 size-20 bg-gray-100 rounded-lg dark:bg-neutral-800" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSYnn9YqVuB4atmKPqDqvkG3BHkXFoTkbo9LA&s" alt="Review Image"/>
                      </div>
...
The management was extremely cooperative and professional throughout the booking process and on the event day. They provided all the necessary support – from stage setup to cleanliness and parking arrangements. Our guests were very impressed with the overall atmosphere and convenience.                      </p>
              ...
              {/* <!-- Tab Content --> */}
              <div id="hs-pro-tabs-shpm-four-star" class="hidden" role="tabpanel" aria-labelledby="hs-pro-tabs-shpm-item-four-star">
                {/* <!-- Product Details --> */}
                <div class="grid sm:grid-cols-2 gap-4">
              ...
              {/* <!-- Tab Content --> */}
              <div id="hs-pro-tabs-shpm-three-star" class="hidden" role="tabpanel" aria-labelledby="hs-pro-tabs-shpm-item-three-star">
                {/* <!-- Product Details --> */}
                <div class="grid sm:grid-cols-2 gap-4">
              ...
              {/* <!-- Tab Content --> */}
              <div id="hs-pro-tabs-shpm-two-and-below" class="hidden" role="tabpanel" aria-labelledby="hs-pro-tabs-shpm-item-two-and-below">
                {/* <!-- Product Details --> */}
                <div class="grid sm:grid-cols-2 gap-4">
            ...
            <div class="pt-14 pb-10">
              ...
              {/* <!-- Collapse --> */}
               <div class="mt-10">
                  ...
                  <div class="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-y-6 sm:gap-x-10 lg:gap-y-12 lg:gap-x-16">
  {/* <!-- Icon Block --> */}
  <div class="flex gap-3">
<img src="https://cdn-icons-png.flaticon.com/128/12728/12728042.png" alt="Guest Accommodation" class="w-5 h-5"/>
  ...
  {/* <!-- Icon Block --> */}
  <div class="flex gap-3">
    <img src="https://cdn-icons-png.flaticon.com/128/2503/2503511.png" alt="Car Parking" class="w-5 h-5"/>
  ...
  {/* <!-- Icon Block --> */}
  <div class="flex gap-3">
     <img src="https://cdn-icons-png.flaticon.com/128/2206/2206927.png" alt="Power Backup" class="w-5 h-5"/>
  ...
  {/* <!-- Icon Block --> */}
  <div class="flex gap-3">
    <img src="https://cdn-icons-png.flaticon.com/128/8182/8182918.png" alt="Parking Area" class="w-5 h-5"/>
  ...
  {/* <!-- Icon Block --> */}
  <div class="flex gap-3">
<img src="https://cdn-icons-png.flaticon.com/128/7969/7969763.png" alt="Air Conditioning" class="w-5 h-5"/>
  ...
  {/* <!-- Icon Block --> */}
  <div class="flex gap-3">
    <img src="https://cdn-icons-png.flaticon.com/128/16427/16427256.png" alt="Two-Wheeler Parking" class="w-5 h-5"/>
    <span>Two-Wheeler Parking</span>

  </div>
  {/* <!-- End Icon Block --> */}
   <div class="flex gap-3">
<img src="https://cdn-icons-png.flaticon.com/128/4566/4566703.png" alt="Furniture" class="w-5 h-5"/>
    <span>Furniture</span>
  ...
  <div class="flex gap-3">
    ...
    <img src="https://cdn-icons-png.flaticon.com/128/3011/3011817.png" alt="Valet Parking" class="w-5 h-5"/>
              ...
              <div class="max-w-4xl mx-auto">
                  ...
                  <div class="flex items-center text-sm text-gray-500 mb-4 space-x-2">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.75 3a.75.75 0 00-.75.75v.75H8a2 2 0 00-2 2v1.5a2 2 0 002 2h8a2 2 0 002-2V7.5a2 2 0 00-2-2h-1V3.75a.75.75 0 00-.75-.75h-5.5zM6 11.25v6.5A3.25 3.25 0 009.25 21h5.5A3.25 3.25 0 0018 17.75v-6.5a.75.75 0 00-.75-.75H6.75a.75.75 0 00-.75.75z" />
                    </svg>
 ...
 <div>
      ...
      >
        {expanded ? "View Less" : "View More"}
                ...
                <div class="mt-10">
                  <h2 class="text-xl font-semibold mb-4">Facilities and Capacity</h2>
                  <p class="text-gray-700 leading-relaxed mb-4">
                    <strong>VM Grand Mahal</strong> features a spacious indoor banquet hall accommodating 20 to 1000 guests, ideal for memorable celebrations. With top-notch amenities and a vibrant ambience, it ensures a unique and enjoyable experience.
                  </p>
                  <p class="text-gray-700 leading-relaxed">
...
{/* <!-- End Grid --> */}
          ...
          <div id="hs-sticky-sidebar-desktop-wrapper" class="lg:col-span-2">
            <div class="ml-4 pt-8 lg:pt-0 h-full" data-hs-switch-place='{
              "xs": "#hs-sticky-sidebar-mobile-wrapper",
              "lg": "#hs-sticky-sidebar-desktop-wrapper"
            }'>
              {/* <!-- Product Details --> */}
              <div class="lg:ps-12 h-full flex flex-col">
                ...
                <div class="mt-2 flex items-center gap-2 mb-4">
                  <img src="https://cdn-icons-png.flaticon.com/128/684/684809.png" alt="Location Icon" class="w-5 h-5 mr-2 text-gray-500"/>
                  <a href="#" class="text-blue-600 hover:underline">Potheri, Chennai</a>
                </div>
                {/* <!-- End Badge Group --> */}

                <div class="mt-3">
                  {/* <!-- Reviews --> */}
                  <a class="inline-block font-medium text-gray-800 hover:text-emerald-600 focus:outline-hidden focus:text-emerald-600 dark:text-neutral-200 dark:hover:text-emerald-500 dark:focus:text-emerald-500" href="#reviews">
                    <ul class="flex flex-wrap items-center gap-2">
                      <li class="inline-flex items-center relative pe-2.5 last:pe-0 last:after:hidden after:absolute after:top-1/2 after:end-0 after:inline-block after:size-[3px] after:bg-gray-400 after:rounded-full after:-translate-y-1/2 dark:after:bg-neutral-600">
                        {/* <!-- Rating --> */}
                        <div class="flex flex-wrap items-center">
                ...
                <div class="mt-5">
                  ...
                  <div class="grid grid-cols-2 gap-2">
                    {/* <!-- Checkbox --> */}
                    <label for="hs-pro-shmfdsr-pro" class="group relative overflow-hidden flex items-center gap-2 p-2 text-sm bg-white text-gray-800 border border-gray-200 cursor-pointer rounded-xl dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-200
                    ...
                    dark:has-disabled:after:bg-[linear-gradient(to_right_bottom,transparent_calc(50%-1px),var(--color-neutral-700)_calc(50%-1px),var(--color-neutral-700)_50%,transparent_50%)] ">
                      <input type="radio" id="hs-pro-shmfdsr-pro" class="hidden bg-transparent border-gray-200 text-emerald-600 focus:ring-white focus:ring-offset-0 dark:text-emerald-500 dark:border-neutral-700 dark:focus:ring-neutral-900" name="hs-pro-shmfdsr"/>
                      <img class="shrink-0 size-10 rounded-md" src="https://cdn-icons-png.flaticon.com/128/4812/4812872.png" alt="Product Image"/>
                    ...
                    <div class="bg-white border border-gray-200 rounded-2xl dark:bg-neutral-900 dark:border-neutral-700">
                      <div class="p-5">
                        ...
                        <div class="flex flex-wrap justify-between items-center gap-1">
                          <div class="grow">
                            <span class="font-semibold text-3xl text-gray-800 dark:text-neutral-200">
                              ₹135000 <span class="text-xl">INR</span>
                            </span>
                        ...
                        <div class="mt-2 flex flex-wrap items-center gap-1">
                          <span class="py-0.5 px-1.5 text-[11px] border border-orange-500 text-orange-500 rounded-md">
                            -15% Limited time
                          </span>
                        </div>
                        {/* <!-- End Badge Group --> */}
                        ...
                        <div class="mt-5 grid grid-cols-2 items-center gap-2">
                          ...
                          <div class="relative">
                            <div class="absolute inset-y-0 start-0 flex items-center ps-2.5">
                              <span class="text-l text-gray-800 dark:text-neutral-200">Date:</span>
                            </div>

                            <input 
                              type="date" 
                              class="py-2 ps-20 pe-8 w-full inline-block border-gray-200 rounded-full text-sm text-gray-800 cursor-pointer hover:bg-gray-50 focus:border-emerald-500 focus:ring-emerald-500 focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-300 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                              min="{{ today }}"
                            />
                          </div>
                        </div>
                      ...
                      {/* <!-- Card List --> */}
                      <div class="p-5 divide-y divide-gray-200 dark:divide-neutral-700">
                        {/* <!-- Card List Item --> */}
                        <div class="py-4 first:pt-0 last:pb-0 flex gap-x-3">
                        <img class="shrink-0 size-6 rounded-md" src="https://cdn-icons-png.flaticon.com/128/857/857681.png" alt="Product Image"/>
 

                          <div class="grow">
                            <h2 class="font-medium text-l text-gray-800 dark:text-neutral-200">
                              Price per Plate ₹380
                            </h2>

                            {/* <!-- List --> */}
                            <div class="mt-1.5 flex flex-col gap-y-0.5">
                              {/* <!-- Item --> */}
                              <div class="flex items-center gap-x-1">
                                ...
                                <div>
                                  <button type="button" class="flex items-center gap-x-1 text-start font-medium text-sm text-emerald-600 underline-offset-4 hover:underline focus:outline-hidden focus:underline dark:text-neutral-200 dark:hover:text-neutral-300 dark:focus:text-neutral-300">
                                    Veg & Non-veg
                                  </button>
                                </div>
                        ...
                        {/* <!-- Card List Item --> */}
                        <div class="py-4 first:pt-0 last:pb-0 flex gap-x-3">
                            <img class="shrink-0 size-6 rounded-md" src="https://cdn-icons-png.flaticon.com/128/14772/14772872.png" alt="Product Image"/>
                        ...
                        {/* <!-- Card List Item --> */}
                        <div class="py-4 first:pt-0 last:pb-0 flex gap-x-3">
                            <img class="shrink-0 size-6 rounded-md" src="https://cdn-icons-png.flaticon.com/128/15817/15817392.png" alt="Product Image"/>
    ...
    {/* <!-- Explore Interests --> */}
    <div class="py-6 sm:py-12 w-full max-w-[85rem] px-4 sm:px-6 lg:px-8 mx-auto">
      {/* <!-- Header --> */}
    ...
    <div>
      ...
      {/* <!-- Grid --> */}
      <div class="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-5 gap-y-10 gap-x-4">
        {/* <!-- Card --> */}
            ...
            <div class="pt-3">
              ...
              <div class="mt-1 flex flex-wrap items-center gap-1">
                <span class="font-semibold text-emerald-600 dark:text-emerald-500">
                  ₹90000 <span class="text-sm">INR</span>
                </span>
                <span class="text-sm text-gray-500 dark:text-neutral-500">
                  <s>₹100000</s>
                </span>
      ...
      300-450
      <svg class="shrink-0 size-3 bi bi-person-fill" xmlns="[http://www.w3.org/2000/svg](http://www.w3.org/2000/svg)" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
        ...
        <div class="h-full flex flex-col">
          <div class="group relative">
            ...
            <div class="pt-3">
              ...
              <div class="mt-1 flex flex-wrap items-center gap-1">
                <span class="font-semibold text-emerald-600 dark:text-emerald-500">
                  ₹150000 <span class="text-sm">INR</span>
                </span>
                <span class="text-sm text-gray-500 dark:text-neutral-500">
                  <s>₹175000</s>
                </span>
       ...
       <div class="h-full flex flex-col">
          <div class="group relative">
            ...
            <div class="pt-3">
              ...
              <div class="mt-1 flex flex-wrap items-center gap-1">
                <span class="font-semibold text-emerald-600 dark:text-emerald-500">
                  ₹120000 <span class="text-sm">INR</span>
                </span>
                <span class="ms-auto text-sm text-gray-500 dark:text-neutral-500 flex items-center gap-x-1">
      400-500
      <svg class="shrink-0 size-3 bi bi-person-fill" xmlns="[http://www.w3.org/2000/svg](http://www.w3.org/2000/svg)" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
         ...
         <div class="h-full flex flex-col">
          <div class="group relative">
            ...
            <div class="pt-3">
              ...
              <div class="mt-1 flex flex-wrap items-center gap-1">
                <span class="font-semibold text-emerald-600 dark:text-emerald-500">
                  ₹200000 <span class="text-sm">INR</span>
                </span>
                <span class="text-sm text-gray-500 dark:text-neutral-500">
                  <s>₹225000</s>
                </span>
          ...
          <div className="relative">
            <select
              ...
              data-hs-select='{
                ...
                "optionTemplate": "<div><div class=\"flex items-center gap-x-2\">...</div></div>",
            ...
            >
              ...
              <option
                ...
                data-hs-select-option='{
                  "icon": "<svg class=\"shrink-0 size-4 rounded-full\" ...></svg>"
                }'
              >
