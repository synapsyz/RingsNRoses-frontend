...
"icon": "<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"20\" height=\"20\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.8\" stroke-linecap=\"round\" stroke-linejoin=\"round\" className=\"lucide lucide-camera-icon lucide-camera\"><path d=\"M14.5 4h-5L7 7H4a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-3l-2.5-3z\"/><circle cx=\"12\" cy=\"13\" r=\"3\"/></svg>"
                    ...
                    <div className="hs-carousel flex flex-col sm:flex-row gap-3 sm:gap-5">
                      ...
                      <div className="flex-none order-2 sm:order-1">
                        <div className="hs-carousel-pagination sm:h-175 flex flex-row sm:flex-col gap-3 pb-1.5 sm:pb-0 overflow-x-auto sm:overflow-x-hidden sm:overflow-y-auto [&::-webkit-scrollbar]:h-1 sm:[&::-webkit-scrollbar]:hidden [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500">
                          {[
                            "https://cdn0.weddingwire.in/vendor/6050/3_2/960/jpg/pic00969_15_436050-168574165457016.webp",
                            "https://cdn0.weddingwire.in/vendor/6050/3_2/960/jpg/banquet-halls-vm-grand-mahal-event-space-2_15_436050-167403629310495.webp",
                            "https://cdn0.weddingwire.in/vendor/6050/3_2/960/jpg/banquet-halls-vm-grand-mahal-event-space-1_15_436050-167403627731052.webp",
                            "https://cdn0.weddingwire.in/vendor/6050/3_2/960/jpeg/banquet-halls-vm-grand-mahal-event-space-1_15_436050-167403626572101.webp",
                            "https://cdn0.weddingwire.in/vendor/6050/3_2/1280/jpg/pic00937-dining_15_436050-167599220426128.webp",
                            "https://cdn0.weddingwire.in/vendor/6050/3_2/960/jpeg/whatsapp-image-2023-06-06-at-8-12-26-pm-1_15_436050-168645021291994.webp",
                            "https://cdn0.weddingwire.in/vendor/6050/3_2/1280/jpg/502a4531_15_436050-168645021732047.webp",
                            "https://cdn0.weddingwire.in/vendor/6050/3_2/960/jpeg/banquet-halls-vm-grand-mahal-event-space-1_15_436050-167403626572101.webp",
                            "https://cdn0.weddingwire.in/vendor/6050/original/960/jpg/pic00911-ganesh_15_436050-167599229237042.webp",
                            "https://cdn0.weddingwire.in/vendor/6050/3_2/960/jpg/banquet-halls-vm-grand-mahal-event-space-3_15_436050-167403630555271.webp",
                          ].map((src, index) => (
                            <div
                              key={index}
                      ...
                      <div className="relative group grow overflow-hidden h-137.5 sm:h-175 order-1 sm:order-2 bg-gray-100 rounded-lg dark:bg-neutral-800">
                        <div className="hs-carousel-body absolute inset-y-0 start-0 flex flex-nowrap opacity-0">
                          {[
                            ...
                            <div key={index} className="hs-carousel-slide">
                              <img
                                className="bg-gray-100 size-full object-cover rounded-lg dark:bg-neutral-800"
                                src={src}
                                alt="Product Image"
                              />
                            </div>
                        ...
                        <button
                          type="button"
                          className="hs-carousel-prev group-hover:opacity-100 opacity-0 absolute top-1/2 start-2 inline-flex justify-center items-center size-10 bg-white border border-gray-100 text-gray-800 rounded-full shadow-2xs hover:bg-gray-100 -translate-y-1/2 focus:outline-hidden"
                        >
                        ...
                        <button
                          type="button"
                          className="hs-carousel-next group-hover:opacity-100 opacity-0 absolute top-1/2 end-2 inline-flex justify-center items-center size-10 bg-white border border-gray-100 text-gray-800 rounded-full shadow-2xs hover:bg-gray-100 -translate-y-1/2 focus:outline-hidden"
                        >
