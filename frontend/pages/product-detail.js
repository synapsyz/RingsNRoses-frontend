    ...
    <div className="bg-gray-100 dark:bg-neutral-800">
      <div className="max-w-[85rem] flex justify-between w-full mx-auto py-3 px-4 sm:px-6 lg:px-8">
        <div className="flex items-center gap-x-5">
          <button type="button" className="flex items-center gap-x-1 text-start font-medium text-xs text-gray-800 hover:text-gray-600 focus:outline-hidden focus:text-gray-600 dark:text-neutral-200 dark:hover:text-neutral-300 dark:focus:text-neutral-300" data-hs-overlay="#hs-pro-shmnlcm">
          ...
          <ol className=" flex items-center whitespace-nowrap">
            ...
            <li className="flex items-center truncate">
              ...
              <a className="py-0.5 px-1.5 flex items-center truncate gap-x-1 text-sm truncate rounded-md text-gray-600 hover:bg-gray-100 focus:bg-gray-100 focus:outline-hidden dark:text-neutral-400 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800" href="listing.html">
                <span className="truncate">Mahals</span>
              </a>
              <svg className="shrink-0 overflow-visible size-4  text-gray-400 dark:text-neutral-600" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                <path d="M6 13L10 3" stroke="currentColor" strokeLinecap="round"></path>
              </svg>
                ...
                <div className="flex-none order-2 sm:order-1">
                  <div className="hs-carousel-pagination sm:h-175 flex flex-row sm:flex-col gap-3 pb-1.5 sm:pb-0 overflow-x-auto sm:overflow-x-hidden sm:overflow-y-auto [&::-webkit-scrollbar]:h-1 sm:[&::-webkit-scrollbar]:hidden [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500">
                    <div className="hs-carousel-pagination-item relative shrink-0 size-20 rounded-md sm:rounded-lg overflow-hidden cursor-pointer after:absolute after:inset-0 after:size-full after:rounded-md sm:after:rounded-lg border border-gray-200 hs-carousel-active:border-gray-800 hs-carousel-active:after:bg-black/10 dark:hs-carousel-active:border-white dark:border-neutral-700">
                      <img className="bg-gray-100 size-full object-cover rounded-md sm:rounded-lg dark:bg-neutral-800" src="https://cdn0.weddingwire.in/vendor/6050/3_2/960/jpg/pic00969_15_436050-168574165457016.webp" alt="Product Image"/>
                    </div>
                    <div className="hs-carousel-pagination-item relative shrink-0 size-20 rounded-md sm:rounded-lg overflow-hidden cursor-pointer after:absolute after:inset-0 after:size-full after:rounded-md sm:after:rounded-lg border border-gray-200 hs-carousel-active:border-gray-800 hs-carousel-active:after:bg-black/10 dark:hs-carousel-active:border-white dark:border-neutral-700">
                      <img className="bg-gray-100 size-full object-cover rounded-md sm:rounded-lg dark:bg-neutral-800" src="https://cdn0.weddingwire.in/vendor/6050/3_2/960/jpg/banquet-halls-vm-grand-mahal-event-space-2_15_436050-167403629310495.webp" alt="Product Image"/>
                    </div>
                    <div className="hs-carousel-pagination-item relative shrink-0 size-20 rounded-md sm:rounded-lg overflow-hidden cursor-pointer after:absolute after:inset-0 after:size-full after:rounded-md sm:after:rounded-lg border border-gray-200 hs-carousel-active:border-gray-800 hs-carousel-active:after:bg-black/10 dark:hs-carousel-active:border-white dark:border-neutral-700">
                      <img className="bg-gray-100 size-full object-cover rounded-md sm:rounded-lg dark:bg-neutral-800" src="https://cdn0.weddingwire.in/vendor/6050/3_2/960/jpg/banquet-halls-vm-grand-mahal-event-space-1_15_436050-167403627731052.webp" alt="Product Image"/>
                    </div>
                    <div className="hs-carousel-pagination-item relative shrink-0 size-20 rounded-md sm:rounded-lg overflow-hidden cursor-pointer after:absolute after:inset-0 after:size-full after:rounded-md sm:after:rounded-lg border border-gray-200 hs-carousel-active:border-gray-800 hs-carousel-active:after:bg-black/10 dark:hs-carousel-active:border-white dark:border-neutral-700">
                      <img className="bg-gray-100 size-full object-cover rounded-md sm:rounded-lg dark:bg-neutral-800" src="https://cdn0.weddingwire.in/vendor/6050/3_2/960/jpeg/banquet-halls-vm-grand-mahal-event-space-1_15_436050-167403626572101.webp" alt="Product Image"/>
                    </div>
                    <div className="hs-carousel-pagination-item relative shrink-0 size-20 rounded-md sm:rounded-lg overflow-hidden cursor-pointer after:absolute after:inset-0 after:size-full after:rounded-md sm:after:rounded-lg border border-gray-200 hs-carousel-active:border-gray-800 hs-carousel-active:after:bg-black/10 dark:hs-carousel-active:border-white dark:border-neutral-700">
                      <img className="bg-gray-100 size-full object-cover rounded-md sm:rounded-lg dark:bg-neutral-800" src="https://cdn0.weddingwire.in/vendor/6050/3_2/1280/jpg/pic00937-dining_15_436050-167599220426128.webp" alt="Product Image"/>
                    </div>
                    <div className="hs-carousel-pagination-item relative shrink-0 size-20 rounded-md sm:rounded-lg overflow-hidden cursor-pointer after:absolute after:inset-0 after:size-full after:rounded-md sm:after:rounded-lg border border-gray-200 hs-carousel-active:border-gray-800 hs-carousel-active:after:bg-black/10 dark:hs-carousel-active:border-white dark:border-neutral-700">
                      <img className="bg-gray-100 size-full object-cover rounded-md sm:rounded-lg dark:bg-neutral-800" src="https://cdn0.weddingwire.in/vendor/6050/3_2/960/jpeg/whatsapp-image-2023-06-06-at-8-12-26-pm-1_15_436050-168645021291994.webp" alt="Product Image"/>
                    </div>
                    <div className="hs-carousel-pagination-item relative shrink-0 size-20 rounded-md sm:rounded-lg overflow-hidden cursor-pointer after:absolute after:inset-0 after:size-full after:rounded-md sm:after:rounded-lg border border-gray-200 hs-carousel-active:border-gray-800 hs-carousel-active:after:bg-black/10 dark:hs-carousel-active:border-white dark:border-neutral-700">
                      <img className="bg-gray-100 size-full object-cover rounded-md sm:rounded-lg dark:bg-neutral-800" src="https://cdn0.weddingwire.in/vendor/6050/3_2/1280/jpg/502a4531_15_436050-168645021732047.webp" alt="Product Image"/>
                    </div>
                    <div className="hs-carousel-pagination-item relative shrink-0 size-20 rounded-md sm:rounded-lg overflow-hidden cursor-pointer after:absolute after:inset-0 after:size-full after:rounded-md sm:after:rounded-lg border border-gray-200 hs-carousel-active:border-gray-800 hs-carousel-active:after:bg-black/10 dark:hs-carousel-active:border-white dark:border-neutral-700">
                      <img className="bg-gray-100 size-full object-cover rounded-md sm:rounded-lg dark:bg-neutral-800" src="https://cdn0.weddingwire.in/vendor/6050/3_2/960/jpeg/banquet-halls-vm-grand-mahal-event-space-1_15_436050-167403626572101.webp" alt="Product Image"/>
                    </div>
                    <div className="hs-carousel-pagination-item relative shrink-0 size-20 rounded-md sm:rounded-lg overflow-hidden cursor-pointer after:absolute after:inset-0 after:size-full after:rounded-md sm:after:rounded-lg border border-gray-200 hs-carousel-active:border-gray-800 hs-carousel-active:after:bg-black/10 dark:hs-carousel-active:border-white dark:border-neutral-700">
                      <img className="bg-gray-100 size-full object-cover rounded-md sm:rounded-lg dark:bg-neutral-800" src="https://cdn0.weddingwire.in/vendor/6050/original/960/jpg/pic00911-ganesh_15_436050-167599229237042.webp" alt="Product Image"/>
                    </div>
                    <div className="hs-carousel-pagination-item relative shrink-0 size-20 rounded-md sm:rounded-lg overflow-hidden cursor-pointer after:absolute after:inset-0 after:size-full after:rounded-md sm:after:rounded-lg border border-gray-200 hs-carousel-active:border-gray-800 hs-carousel-active:after:bg-black/10 dark:hs-carousel-active:border-white dark:border-neutral-700">
                      <img className="bg-gray-100 size-full object-cover rounded-md sm:rounded-lg dark:bg-neutral-800" src="https://cdn0.weddingwire.in/vendor/6050/3_2/960/jpg/banquet-halls-vm-grand-mahal-event-space-3_15_436050-167403630555271.webp" alt="Product Image"/>
                    </div>
                  </div>
                </div>
                {/* <!-- End Thumbnails --> */}
                ...
                <div className="relative group grow overflow-hidden h-137.5 sm:h-175 order-1 sm:order-2 bg-gray-100 rounded-lg dark:bg-neutral-800">
                  <div className="hs-carousel-body absolute inset-y-0 start-0 flex flex-nowrap opacity-0">
                    <div className="hs-carousel-slide">
                      <img className="bg-gray-100 size-full object-cover rounded-lg dark:bg-neutral-800" src="https://cdn0.weddingwire.in/vendor/6050/3_2/960/jpg/pic00969_15_436050-168574165457016.webp" alt="Product Image"/>
                    </div>
                    <div className="hs-carousel-slide">
                      <img className="bg-gray-100 size-full object-cover rounded-lg dark:bg-neutral-800" src="https://cdn0.weddingwire.in/vendor/6050/3_2/960/jpg/banquet-halls-vm-grand-mahal-event-space-2_15_436050-167403629310495.webp" alt="Product Image"/>
                    </div>
                    <div className="hs-carousel-slide">
                      <img className="bg-gray-100 size-full object-cover rounded-lg dark:bg-neutral-800" src="https://cdn0.weddingwire.in/vendor/6050/3_2/960/jpg/banquet-halls-vm-grand-mahal-event-space-1_15_436050-167403627731052.webp" alt="Product Image"/>
                    </div>
                    <div className="hs-carousel-slide">
                      <img className="bg-gray-100 size-full object-cover rounded-lg dark:bg-neutral-800" src="https://cdn0.weddingwire.in/vendor/6050/3_2/960/jpeg/banquet-halls-vm-grand-mahal-event-space-1_15_436050-167403626572101.webp" alt="Product Image"/>
                    </div>
                    <div className="hs-carousel-slide">
                      <img className="bg-gray-100 size-full object-cover rounded-lg dark:bg-neutral-800" src="https://cdn0.weddingwire.in/vendor/6050/3_2/1280/jpg/pic00937-dining_15_436050-167599220426128.webp" alt="Product Image"/>
                    </div>
                    <div className="hs-carousel-slide">
                      <img className="bg-gray-100 size-full object-cover rounded-lg dark:bg-neutral-800" src="https://cdn0.weddingwire.in/vendor/6050/3_2/960/jpeg/whatsapp-image-2023-06-06-at-8-12-26-pm-1_15_436050-168645021291994.webp" alt="Product Image"/>
                    </div>
                    <div className="hs-carousel-slide">
                      <img className="bg-gray-100 size-full object-cover rounded-lg dark:bg-neutral-800" src="https://cdn0.weddingwire.in/vendor/6050/3_2/1280/jpg/502a4531_15_436050-168645021732047.webp" alt="Product Image"/>
                    </div>
                    <div className="hs-carousel-slide">
                      <img className="bg-gray-100 size-full object-cover rounded-lg dark:bg-neutral-800" src="https://cdn0.weddingwire.in/vendor/6050/3_2/960/jpeg/banquet-halls-vm-grand-mahal-event-space-1_15_436050-167403626572101.webp" alt="Product Image"/>
                    </div>
                    <div className="hs-carousel-slide">
                      <img className="bg-gray-100 size-full object-cover rounded-lg dark:bg-neutral-800" src="https://cdn0.weddingwire.in/vendor/6050/original/960/jpg/pic00911-ganesh_15_436050-167599229237042.webp" alt="Product Image"/>
                    </div>
                    <div className="hs-carousel-slide">
                      <img className="bg-gray-100 size-full object-cover rounded-lg dark:bg-neutral-800" src="https://cdn0.weddingwire.in/vendor/6050/3_2/960/jpg/banquet-halls-vm-grand-mahal-event-space-3_15_436050-167403630555271.webp" alt="Product Image"/>
                    </div>
                  </div>

                  {/* <!-- Nav --> */}
                  <button type="button" className="hs-carousel-prev group-hover:opacity-100 opacity-0 absolute top-1/2 start-2 inline-flex justify-center items-center size-10 bg-white border border-gray-100 text-gray-800 rounded-full shadow-2xs hover:bg-gray-100 -translate-y-1/2 focus:outline-hidden">
                  ...
                  <button type="button" className="hs-carousel-next group-hover:opacity-100 opacity-0 absolute top-1/2 end-2 inline-flex justify-center items-center size-10 bg-white border border-gray-100 text-gray-800 rounded-full shadow-2xs hover:bg-gray-100 -translate-y-1/2 focus:outline-hidden">
            ...
            <div className="ml-4 pt-8 lg:pt-0 h-full" data-hs-switch-place='{
              ...
              <div className="lg:ps-12 h-full flex flex-col">
                ...
                <div className="mt-2 flex items-center gap-2 mb-4">
                  ...
                  <a href="#" className="text-blue-600 hover:underline">Potheri, Chennai</a>
                </div>
                {/* <!-- End Badge Group --> */}
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-5 gap-y-10 gap-x-4">
       ...
       <div className="h-full flex flex-col">
          <div className="group relative">
            <div className="relative">
              <a className="block shrink-0 relative w-full h-48 md:h-64 overflow-hidden rounded-xl focus:outline-hidden" href="../../pro/shop-marketplace/product-detail">
                <img className="size-full absolute inset-0 object-cover object-center group-hover:scale-105 group-focus:scale-105 transition-transform duration-500 ease-in-out rounded-xl" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTx_dGPXv0JN3-nkPUgbdbGVT1mzSY6_RNcnQ&s" alt="Resorts"/>
              </a>
