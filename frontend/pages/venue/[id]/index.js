...
export default function ProductDetail() {
  ...
  useEffect(() => {
    const fetchVenueData = async () => {
      setLoading(true);
      try {
        if(venueData?.location_details?.id !== undefined){
        ...
        const sug = await api.get(
          `/venues/?location=${venueData?.location_details?.id}`,
          config
        );
  ...
  useEffect(() => {
    ...
    function contentToSwitch() {
      ...
      const contentToSwitchEls = document.querySelectorAll(
  ...
  useEffect(() => {
    ...
    function onLoad() {
      (function () {
        ...
        const scrollNav = window.HSScrollNav.getInstance(
          "#hs-pro-reviews-tabs-scroll",
          true
        );
        ...
        window.addEventListener("change.hs.tab", ({ detail }) => {
          ...
          const tabsScrollEl = document.querySelector(
            "#hs-pro-reviews-tabs-scroll"
          );
                  ...
                  <LocationSelector
                    ...
                    onSave={(selectedLocationData) => {
                      ...
                      setSelectedLocationName(
                        selectedLocationData.location || "Chennai"
              ...
              <div className="md:w-full order-2 md:grow md:w-auto">
                <div className="relative flex basis-full items-center gap-x-1 md:gap-x-3">
                  ...
                  <div className="hs-dropdown [--adaptive:none] [--auto-close:inside] md:inline-block">
                    ...
                    {/* {/* <!-- Dropdown Menu -->  */}
                    <div
                      className="hs-dropdown-menu hs-dropdown-open:opacity-100 opacity-0 w-full hidden z-20 top-full start-0 min-w-60 bg-white shadow-xl before:absolute before:-top-4 before:start-0 before:w-full before:h-5 dark:bg-neutral-900 dark:border-neutral-700"
                      role="menu"
                      aria-orientation="vertical"
                      aria-labelledby="hs-pro-shmnctdm"
                    >
                      {/* {/* <!-- Container -->  */}
                      <div className="max-w-[85rem] w-full mx-auto py-2 md:py-4 px-4 sm:px-6 lg:px-8">
                        <select
                          id="hs-catalog-sidebar-nav-select"
                          className="hidden"
...
"icon": "<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"20\" height=\"20\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" strokeWidth=\"1.8\" strokeLinecap=\"round\" strokeLinejoin=\"round\" className=\"lucide lucide-camera-icon lucide-camera\"><path d=\"M14.5 4h-5L7 7H4a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-3l-2.5-3z\"/><circle cx=\"12\" cy=\"13\" r=\"3\"/></svg>"
 ...
 "icon": "<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"20\" height=\"20\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" strokeWidth=\"1.8\" strokeLinecap=\"round\" strokeLinejoin=\"round\" className=\"lucide lucide-gift-icon lucide-gift\"><rect x=\"3\" y=\"8\" width=\"18\" height=\"4\" rx=\"1\"/><path d=\"M12 8v13\"/><path d=\"M19 12v7a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2v-7\"/><path d=\"M7.5 8a2.5 2.5 0 0 1 0-5A4.8 8 0 0 1 12 8a4.8 8 0 0 1 4.5-5 2.5 2.5 0 0 1 0 5\"/></svg>"
                          ...
                          <option
                            value="#mega-menu-catalog-tab-11"
                            data-hs-select-option='{
"icon": "<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"20\" height=\"20\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" strokeWidth=\"1.8\" strokeLinecap=\"round\" strokeLinejoin=\"round\" className=\"lucide lucide-brush-icon lucide-brush\"><path d=\"m11 10 3 3\"/><path d=\"M6.5 21A3.5 3.5 0 1 0 3 17.5a2.62 2.62 0 0 1-.708 1.792A1 1 0 0 0 3 21z\"/><path d=\"M9.969 17.031 21.378 5.624a1 1 0 0 0-3.002-3.002L6.967 14.031\"/></svg>"
                          ...
                          <option
                            value="#mega-menu-catalog-tab-13"
                            data-hs-select-option='{
"icon": "<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"20\" height=\"20\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" strokeWidth=\"1.8\" strokeLinecap=\"round\" strokeLinejoin=\"round\" className=\"lucide lucide-hand-coins-icon lucide-hand-coins\"><path d=\"M11 15h2a2 2 0 1 0 0-4h-3c-.6 0-1.1.2-1.4.6L3 17\"/><path d=\"m7 21 1.6-1.4c.3-.4.8-.6 1.4-.6h4c1.1 0 2.1-.4 2.8-1.2l4.6-4.4a2 2 0 0 0-2.75-2.91l-4.2 3.9\"/><path d=\"m2 16 6 6\"/><circle cx=\"16\" cy=\"9\" r=\"2.9\"/><circle cx=\"6\" cy=\"5\" r=\"3\"/></svg>"
                        ...
                        <div className="flex">
                          ...
                          <div className="hidden sm:block sm:pe-4 w-96 h-[75dvh] overflow-y-auto [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500">
                            <div
                              id="hs-catalog-sidebar-nav-tabs"
                        ...
                        "preventNavigationResolution": "sm"
                            ...
                            >
                              {/* {/* <!-- Link -->  */}
                              <a
                                className="hs-tab-active:bg-gray-100 dark:hs-tab-active:bg-neutral-800 py-2.5 px-2 w-full flex items-center gap-x-2 text-start font-medium text-sm bg-white text-gray-800 rounded-lg hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 dark:bg-neutral-900 dark:text-neutral-200 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800 active"
                                id="mega-menu-catalog-tab-item-1"
                                aria-selected="true"
                                data-hs-tab="#mega-menu-catalog-tab-1"
                                aria-controls="mega-menu-catalog-tab-1"
                                role="tab"
                                href="#"
                              >
                                <svg
                                ...
                                Venue
                                <svg
                                  className="shrink-0 size-3.5 ms-auto text-gray-500 dark:text-neutral-500"
                                  xmlns="http://www.w3.org/2000/svg"
                                  width="24"
                                  height="24"
                                  viewBox="0 0 24 24"
                              ...
                              {/* {/* <!-- Link -->  */}
                              <a
                                className="hs-tab-active:bg-gray-100 dark:hs-tab-active:bg-neutral-800 py-2.5 px-2 w-full flex items-center gap-x-2 text-start font-medium text-sm bg-white text-gray-800 rounded-lg hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 dark:bg-neutral-900 dark:text-neutral-200 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800"
                                id="mega-menu-catalog-tab-item-2"
                                aria-selected="false"
                                data-hs-tab="#mega-menu-catalog-tab-2"
                                aria-controls="mega-menu-catalog-tab-2"
                                role="tab"
                                href="#"
                              >
                                <svg
                              ...
                              <a
                                className="hs-tab-active:bg-gray-100 dark:hs-tab-active:bg-neutral-800 py-2.5 px-2 w-full flex items-center gap-x-2 text-start font-medium text-sm bg-white text-gray-800 rounded-lg hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 dark:bg-neutral-900 dark:text-neutral-200 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800"
                                id="mega-menu-catalog-tab-item-3"
                                aria-selected="false"
                                data-hs-tab="#mega-menu-catalog-tab-3"
                                aria-controls="mega-menu-catalog-tab-3"
                                role="tab"
                                href="#"
                              >
                                <svg
                              ...
                              <a
                                className="hs-tab-active:bg-gray-100 dark:hs-tab-active:bg-neutral-800 py-2.5 px-2 w-full flex items-center gap-x-2 text-start font-medium text-sm bg-white text-gray-800 rounded-lg hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 dark:bg-neutral-900 dark:text-neutral-200 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800"
                                id="mega-menu-catalog-tab-item-4"
                                aria-selected="false"
                                data-hs-tab="#mega-menu-catalog-tab-4"
                                aria-controls="mega-menu-catalog-tab-4"
                                role="tab"
                                href="#"
                              >
                                <svg
                              ...
                              <a
                                className="hs-tab-active:bg-gray-100 dark:hs-tab-active:bg-neutral-800 py-2.5 px-2 w-full flex items-center gap-x-2 text-start font-medium text-sm bg-white text-gray-800 rounded-lg hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 dark:bg-neutral-900 dark:text-neutral-200 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800"
                                id="mega-menu-catalog-tab-item-5"
                                aria-selected="false"
                                data-hs-tab="#mega-menu-catalog-tab-5"
                                aria-controls="mega-menu-catalog-tab-5"
                                role="tab"
                                href="#"
                              >
                                <svg
                              ...
                              <a
                                className="hs-tab-active:bg-gray-100 dark:hs-tab-active:bg-neutral-800 py-2.5 px-2 w-full flex items-center gap-x-2 text-start font-medium text-sm bg-white text-gray-800 rounded-lg hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 dark:bg-neutral-900 dark:text-neutral-200 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800"
                                id="mega-menu-catalog-tab-item-6"
                                aria-selected="false"
                                data-hs-tab="#mega-menu-catalog-tab-6"
                                aria-controls="mega-menu-catalog-tab-6"
                                role="tab"
                                href="#"
                              >
                                <svg
                              ...
                              <a
                                className="hs-tab-active:bg-gray-100 dark:hs-tab-active:bg-neutral-800 py-2.5 px-2 w-full flex items-center gap-x-2 text-start font-medium text-sm bg-white text-gray-800 rounded-lg hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 dark:bg-neutral-900 dark:text-neutral-200 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800"
                                id="mega-menu-catalog-tab-item-7"
                                aria-selected="false"
                                data-hs-tab="#mega-menu-catalog-tab-7"
                                aria-controls="mega-menu-catalog-tab-7"
                                role="tab"
                                href="#"
                              >
                                <svg
                              ...
                              <a
                                className="hs-tab-active:bg-gray-100 dark:hs-tab-active:bg-neutral-800 py-2.5 px-2 w-full flex items-center gap-x-2 text-start font-medium text-sm bg-white text-gray-800 rounded-lg hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 dark:bg-neutral-900 dark:text-neutral-200 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800"
                                id="mega-menu-catalog-tab-item-9"
                                aria-selected="false"
                                data-hs-tab="#mega-menu-catalog-tab-9"
                                aria-controls="mega-menu-catalog-tab-9"
                                role="tab"
                                href="#"
                              >
                                <svg
                              ...
                              <a
                                className="hs-tab-active:bg-gray-100 dark:hs-tab-active:bg-neutral-800 py-2.5 px-2 w-full flex items-center gap-x-2 text-start font-medium text-sm bg-white text-gray-800 rounded-lg hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 dark:bg-neutral-900 dark:text-neutral-200 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800"
                                id="mega-menu-catalog-tab-item-11"
                                aria-selected="false"
                                data-hs-tab="#mega-menu-catalog-tab-11"
                                aria-controls="mega-menu-catalog-tab-11"
                                role="tab"
                                href="#"
                              >
                                <svg
                              ...
                              <a
                                className="hs-tab-active:bg-gray-100 dark:hs-tab-active:bg-neutral-800 py-2.5 px-2 w-full flex items-center gap-x-2 text-start font-medium text-sm bg-white text-gray-800 rounded-lg hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 dark:bg-neutral-900 dark:text-neutral-200 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800"
                                id="mega-menu-catalog-tab-item-13"
                                aria-selected="false"
                                data-hs-tab="#mega-menu-catalog-tab-13"
                                aria-controls="mega-menu-catalog-tab-13"
                                role="tab"
                                href="#"
                              >
                                <svg
                          ...
                          <div className="pe-4 sm:px-10 w-full h-[75dvh] overflow-y-auto [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500">
                            ...
                            {/* {/* <!-- Grid -->  */}
                            <div
                              id="mega-menu-catalog-tab-1"
                              className="hidden h-full"
                              role="tabpanel"
                              aria-labelledby="mega-menu-catalog-tab-item-1"
                            >
                              {/* {/* <!-- Grid -->  */}
                              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 gap-3 md:gap-6">
                                {/* {/* <!-- Item -->  */}
                                <a
                                  className="group block p-4 rounded-lg text-center hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800"
                                  href="./listing.html"
                                >
                                  <div className="relative shrink-0">
                                    <img
                                      className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                      src="https://images.venuebookingz.com/24118-1720587040-wm-league-hotels-banquet-chennai-1.jpg"
                                      alt="Product Image"
                                    />
                                  </div>
                                  <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                                    Banquet Halls
                                  </span>
                                </a>
                                {/* {/* <!-- End Item -->  */}
                                ...
                                >
                                  <div className="relative shrink-0">
                                    <img
                                      className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                      src="https://www.unexplora.com/wp-content/uploads/2020/11/Untitled-design-85.jpg"
                                      alt="Product Image"
                                    />
                                  </div>
                                  <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                                ...
                                >
                                  <div className="relative shrink-0">
                                    <img
                                      className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                      src="https://cdn0.weddingwire.in/vendor/4599/3_2/960/jpg/wedding-venue-aj-garden-outdoor-space-1_15_364599-161640601569768.jpeg"
                                      alt="Product Image"
                                    />
                                  </div>
                                  <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                                ...
                                >
                                  <div className="relative shrink-0">
                                    <img
                                      className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                      src="https://www.kalkifashion.com/blogs/wp-content/uploads/2023/01/Top-7-Destination-Wedding-Locations-in-India.jpg"
                                      alt="Product Image"
                                    />
                                  </div>
                                  <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                                ...
                                >
                                  <div className="relative shrink-0">
                                    <img
                                      className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                      src="https://media.weddingz.in/images/ce4bb19da8f580022371692fda5715b5/thinking-of-a-beach-wedding-check-out-the-best-beach-wedding-venues-in-goa-2.jpg"
                                      alt="Product Image"
                                    />
                                  </div>
                                  <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                                ...
                                >
                                  <div className="relative shrink-0">
                                    <img
                                      className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                      src="https://media.weddingz.in/photologue/1490602150941/palace-wedding-venues-in-india-gajner-palace.PNG"
                                      alt="Product Image"
                                    />
                                  </div>
                                  <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                                ...
                                >
                                  <div className="relative shrink-0">
                                    <img
                                      className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                      src="https://imagewedz.oyoroomscdn.com/medium/photologue/images/diamond-banquet-chembur-mumbai-4.jpeg"
                                      alt="Product Image"
                                    />
                                  </div>
                                  <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                                ...
                                >
                                  <div className="relative shrink-0">
                                    <img
                                      className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                      src="https://www.brides.com/thmb/6rWBPzOU1FKL8U4JJWdxTh7v4-8=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/J0GNM_v_QLTPspmntIY9Wx0-blZ0KWIyAGTfiPDU7Vz73PGoHrCJhs8u9UmLiQvm3_tX_NmoFw1ylvOHf_c7M-S112OA0R0X2CuTxIhgaEscCQgLwczPt6ACGKFjcopy-df74a973bac843b69df2ff927153bc12.jpg"
                                      alt="Product Image"
                                    />
                                  </div>
                                  <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                            ...
                            {/* {/* <!-- Grid -->  */}
                            <div
                              id="mega-menu-catalog-tab-2"
                              className="hidden h-full"
                              role="tabpanel"
                              aria-labelledby="mega-menu-catalog-tab-item-2"
                            >
                              <div className="grid grid-cols-3 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-3 md:gap-6">
                                ...
                                >
                                  <div className="relative shrink-0">
                                    <img
                                      className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                      src="https://www.visionvivaah.com/blog/wp-content/uploads/2020/01/best-wedding-dresses-for-indian-bride1.jpg"
                                      alt="Product Image"
                                    />
                                  </div>
                                  <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                                ...
                                >
                                  <div className="relative shrink-0">
                                    <img
                                      className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                      src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQCVQETB2x5r5eCHyaWRCSe3NDxbRI817N1bw&s"
                                      alt="Product Image"
                                    />
                                  </div>
                                  <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                                ...
                                >
                                  <div className="relative shrink-0">
                                    <img
                                      className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                      src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTagJonsg3okffWkoZ2IaItujDfucHwgrQtDg&s"
                                      alt="Product Image"
                                    />
                                  </div>
                                  <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                                ...
                                >
                                  <div className="relative shrink-0">
                                    <img
                                      className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                      src="https://images.shaadisaga.com/shaadisaga_production/photos/pictures/000/476/585/new_medium/tsg_%285%29.jpg?1532692503"
                                      alt="Product Image"
                                    />
                                  </div>
                                  <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                                ...
                                >
                                  <div className="relative shrink-0">
                                    <img
                                      className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                      src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRqBATTreSNWj8iUVlHBekdr4_DhvEjwmfw_Q&s"
                                      alt="Product Image"
                                    />
                                  </div>
                                  <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                                ...
                                >
                                  <div className="relative shrink-0">
                                    <img
                                      className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                      src="https://www.riccoindia.com/cdn/shop/products/IMG_2384_2048x.jpg?v=1657351657"
                                      alt="Product Image"
                                    />
                                  </div>
                                  <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                                ...
                                <div className="col-span-2 flex justify-center">
                                  ...
                                  >
                                    <div className="relative shrink-0">
                                      <img
                                        className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                        src="https://static.fibre2fashion.com//articleresources/images/75/7486/wedding-small_Small.jpg"
                                        alt="Product Image"
                                      />
                                    </div>
                                    <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                                      Bridal Shopping Boutiques
                                    </span>
                                  </a>
                                </div>
                              </div>
                            ...
                            {/* {/* <!-- Grid -->  */}
                            <div
                              id="mega-menu-catalog-tab-3"
                              className="hidden h-full"
                              role="tabpanel"
                              aria-labelledby="mega-menu-catalog-tab-item-3"
                            >
                              {/* {/* <!-- Grid -->  */}
                              <div className="grid grid-cols-3 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-3 md:gap-6">
                                <a
                                ...
                                >
                                  <div className="relative shrink-0">
                                    <img
                                      className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                      src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSDOF--vmxkIKTRlsB_j1cgw1jQZnHZLwyFkA&s"
                                      alt="Product Image"
                                    />
                                  </div>
                                  <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                                ...
                                >
                                  <div className="relative shrink-0">
                                    <img
                                      className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                      src="https://admin.venuelook.com/images/new-home-images/optimized/vendor/caterer.jpg"
                                      alt="Product Image"
                                    />
                                  </div>
                                  <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                                ...
                                >
                                  <div className="relative shrink-0">
                                    <img
                                      className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                      src="https://www.captainjoe.in/images/catering-specialists.jpg"
                                      alt="Product Image"
                                    />
                                  </div>
                                  <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                                ...
                                >
                                  <div className="relative shrink-0">
                                    <img
                                      className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                      src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS4bzBgybsWbj23ahaKRLIzKXg2d9AHF3KJYQ&s"
                                      alt="Product Image"
                                    />
                                  </div>
                                  <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                                    Sweet & Dessert Vendors
                                  </span>
                                </a>
                                <a
                                  className="group block p-4 rounded-lg text-center hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800"
                                ...
                                >
                                  <div className="relative shrink-0">
                                    <img
                                      className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                      src="https://5.imimg.com/data5/SELLER/Default/2020/10/BZ/NO/XH/58672911/neato-foods-ambattur-corporate-canteen-500x500.jpg"
                                      alt="Product Image"
                                    />
                                  </div>
                                  <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                                ...
                                >
                                  <div className="relative shrink-0">
                                    <img
                                      className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                      src="https://tastytablecatering.com/wp-content/uploads/2023/03/bartender-making-cocktails-at-open-bar-wedding.jpg"
                                      alt="Product Image"
                                    />
                                  </div>
                                  <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                                ...
                                <div className="col-span-2 flex justify-center">
                                  ...
                                  >
                                    <div className="relative shrink-0">
                                      <img
                                        className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                        src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRTpNcpPpR6sNUwvc8KCdFLS2p8vJ1d60yiwQ&s"
                                        alt="Product Image"
                                      />
                                    </div>
                                    <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                            ...
                            {/* {/* <!-- End Tab -->  */}
                            <div
                              id="mega-menu-catalog-tab-4"
                              className="hidden h-full"
                              role="tabpanel"
                              aria-labelledby="mega-menu-catalog-tab-item-4"
                            >
                              {/* {/* <!-- Grid -->  */}
                              <div className="grid grid-cols-3 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-3 md:gap-6">
                                <a
                                ...
                                >
                                  <div className="relative shrink-0">
                                    <img
                                      className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                      src="https://www.k4craft.com/wp-content/uploads/2020/01/1Floral-Backdrop.jpg"
                                      alt="Product Image"
                                    />
                                  </div>
                                  <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                                ...
                                >
                                  <div className="relative shrink-0">
                                    <img
                                      className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                      src="https://www.diwas.in/wp-content/uploads/2016/02/rustic.jpg"
                                      alt="Product Image"
                                    />
                                  </div>
                                  <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                                ...
                                >
                                  <div className="relative shrink-0">
                                    <img
                                      className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                      src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRYV7_8nh0kvYPbrPLkwP4J0xEAOaNkF85WwA&s"
                                      alt="Product Image"
                                    />
                                  </div>
                                  <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                                ...
                                >
                                  <div className="relative shrink-0">
                                    <img
                                      className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                      src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSQe_Z8zIy0TvTbyuWiAB5qHLmSTzu2CK2YGA&s"
                                      alt="Product Image"
                                    />
                                  </div>
                                  <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                                ...
                                >
                                  <div className="relative shrink-0">
                                    <img
                                      className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                      src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSjg6YRQtWTZE8cckQ0mpA10gwg5aTx6XmIdw&s"
                                      alt="Product Image"
                                    />
                                  </div>
                                  <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                                ...
                                <div className="col-span-2 flex justify-center">
                                  ...
                                  >
                                    <div className="relative shrink-0">
                                      <img
                                        className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                        src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ3jRG895OPHXwvBu1Rhm6D-fB5ApicSAFHJA&s"
                                        alt="Product Image"
                                      />
                                    </div>
                                    <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                            ...
                            <div
                              id="mega-menu-catalog-tab-5"
                              className="hidden h-full"
                              role="tabpanel"
                              aria-labelledby="mega-menu-catalog-tab-item-5"
                            >
                              {/* {/* <!-- Grid -->  */}
                              <div className="grid grid-cols-3 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-3 md:gap-6">
                                <a
                                ...
                                >
                                  <div className="relative shrink-0">
                                    <img
                                      className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                      src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRLx1bP_LBPqfJ2FCjH24Thk9Ar5u1cAaAKOw&s"
                                      alt="Product Image"
                                    />
                                  </div>
                                  <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                                ...
                                >
                                  <div className="relative shrink-0">
                                    <img
                                      className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                      src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRqDnqOZq4whTmJchZKbntAphh5eTh87pvYxw&s"
                                      alt="Product Image"
                                    />
                                  </div>
                                  <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                                ...
                                >
                                  <div className="relative shrink-0">
                                    <img
                                      className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                      src="https://cdn0.weddingwire.in/article-gallery-o/00000/3_2/960/jpg/articulos-india/2019/non-troncales/puneri-dhol/saurabh-birje-photography-phuneri-dhol-lead-image.jpeg"
                                      alt="Product Image"
                                    />
                                  </div>
                                  <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                                ...
                                >
                                  <div className="relative shrink-0">
                                    <img
                                      className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                      src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQFRFcR4R3TkgAWj_GiasbsDiCNkYlTJR_QRA&s"
                                      alt="Product Image"
                                    />
                                  </div>
                                  <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                                ...
                                >
                                  <div className="relative shrink-0">
                                    <img
                                      className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                      src="https://lh3.googleusercontent.com/cmF2dPVYXKut9jrWPMMjaNEVoCMHkx1LsglSMlVLHxR427Jjimiu0vw7Qq4cBjXFpU3IAJbXL9r0apHjau5QgYvFLPFHV1iNZLduww=w961-h641-l80-e31"
                                      alt="Product Image"
                                    />
                                  </div>
                                  <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                                ...
                                >
                                  <div className="relative shrink-0">
                                    <img
                                      className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                      src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSuaal8xK8xGAaCnoX--044AHMWUoV-1Ofeqg&s"
                                      alt="Product Image"
                                    />
                                  </div>
                                  <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                                ...
                                <div className="col-span-2 flex justify-center">
                                  ...
                                  >
                                    <div className="relative shrink-0">
                                      <img
                                        className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                        src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTvQQU6ucynh7hLi1cDyvyN2VvZ_X4UOZ0_jQ&s"
                                        alt="Product Image"
                                      />
                                    </div>
                                    <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                            ...
                            <div
                              id="mega-menu-catalog-tab-6"
                              className="hidden h-full"
                              role="tabpanel"
                              aria-labelledby="mega-menu-catalog-tab-item-6"
                            >
                              {/* {/* <!-- Grid -->  */}
                              <div className="grid grid-cols-3 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-3 md:gap-6">
                                <a
                                ...
                                >
                                  <div className="relative shrink-0">
                                    <img
                                      className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                      src="https://cdn.kamatharjun.com/wp-content/uploads/2022/10/Prewedding-blog-8.jpg"
                                      alt="Product Image"
                                    />
                                  </div>
                                  <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                                ...
                                >
                                  <div className="relative shrink-0">
                                    <img
                                      className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                      src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSbRhTt7nxPVupZII-bGGMO5qAl8yc5sjZp8Q&s"
                                      alt="Product Image"
                                    />
                                  </div>
                                  <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                                ...
                                >
                                  <div className="relative shrink-0">
                                    <img
                                      className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                      src="https://www.visionvivaah.com/blog/wp-content/uploads/2019/08/best-wedding-videography-in-chandigarh-960x487.jpg"
                                      alt="Product Image"
                                    />
                                  </div>
                                  <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                                ...
                                >
                                  <div className="relative shrink-0">
                                    <img
                                      className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                      src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQwNQVPkGMO4V2IS_FtdvhiKbbmoWiOT5zAeA&s"
                                      alt="Product Image"
                                    />
                                  </div>
                                  <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                                ...
                                >
                                  <div className="relative shrink-0">
                                    <img
                                      className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                      src="https://5.imimg.com/data5/SELLER/Default/2021/2/EX/HF/RA/121338197/pre-wedding-photoshoot-service-500x500.jpg"
                                      alt="Product Image"
                                    />
                                  </div>
                                  <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                                ...
                                >
                                  <div className="relative shrink-0">
                                    <img
                                      className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                      src="https://cdn0.weddingwire.in/vendor/2384/3_2/960/jpg/photobooth-instant-photo-booth-photobooth-4_15_422384-166246147178159.jpeg"
                                      alt="Product Image"
                                    />
                                  </div>
                                  <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                            ...
                            <div
                              id="mega-menu-catalog-tab-7"
                              className="hidden h-full"
                              role="tabpanel"
                              aria-labelledby="mega-menu-catalog-tab-item-7"
                            >
                              {/* {/* <!-- Grid -->  */}
                              <div className="grid grid-cols-3 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-3 md:gap-6">
                                <a
                                ...
                                >
                                  <div className="relative shrink-0">
                                    <img
                                      className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                      src="https://cms.cloudinary.vpsvc.com/image/upload/c_scale,dpr_auto,f_auto,q_auto:best,t_productPageHeroGalleryTransformation_v2,w_auto/India%20LOB/Stationery%2C%20Letterheads%20and%20Stamps/Wedding%20Invitations/IN_Wedding-Invitations_Hero-image_01"
                                      alt="Product Image"
                                    />
                                  </div>
                                  <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                                ...
                                >
                                  <div className="relative shrink-0">
                                    <img
                                      className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                      src="https://i.pinimg.com/736x/9f/7b/91/9f7b91504fc1cc4747f9c1cf05255498.jpg"
                                      alt="Product Image"
                                    />
                                  </div>
                                  <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                                ...
                                >
                                  <div className="relative shrink-0">
                                    <img
                                      className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                      src="https://blogcdn.paperlust.co/blog/wp-content/uploads/2019/08/1.jpg"
                                      alt="Product Image"
                                    />
                                  </div>
                                  <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                                ...
                                >
                                  <div className="relative shrink-0">
                                    <img
                                      className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                      src="https://i.etsystatic.com/18363873/r/il/0fcd9a/1891009885/il_570xN.1891009885_eqav.jpg"
                                      alt="Product Image"
                                    />
                                  </div>
                                  <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                                ...
                                >
                                  <div className="relative shrink-0">
                                    <img
                                      className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                      src="https://cms.cloudinary.vpsvc.com/image/upload/c_scale,dpr_auto,f_auto,q_auto:good,w_700/India%20LOB/Stationery%2C%20Letterheads%20and%20Stamps/Wedding%20Invitations/IN_Wedding-Invitations_Overview"
                                      alt="Product Image"
                                    />
                                  </div>
                                  <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                                ...
                                >
                                  <div className="relative shrink-0">
                                    <img
                                      className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                      src="https://design-assets.adobeprojectm.com/content/download/express/public/urn:aaid:sc:VA6C2:d271d604-d65c-55cd-b287-733effd3a3af/component?assetType=TEMPLATE&etag=35bc0dea77df416bb31c32dc28675a6d&revision=048a2724-6699-4d01-9c6b-62ee9736fb45&component_id=1a690ebd-eddb-4ae1-9e58-8d6d7d99ffb9"
                                      alt="Product Image"
                                    />
                                  </div>
                                  <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                            ...
                            <div
                              id="mega-menu-catalog-tab-9"
                              className="hidden h-full"
                              role="tabpanel"
                              aria-labelledby="mega-menu-catalog-tab-item-9"
                            >
                              <div className="grid grid-cols-3 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-3 md:gap-6">
                                <a
                                  className="group block p-4 rounded-lg text-center hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800"
                                ...
                                >
                                  <div className="relative shrink-0">
                                    <img
                                      className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                      src="https://i.etsystatic.com/18125450/r/il/6f4a57/6104906139/il_570xN.6104906139_gw5l.jpg"
                                      alt="Product Image"
                                    />
                                  </div>
                                  <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                                ...
                                >
                                  <div className="relative shrink-0">
                                    <img
                                      className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                      src="https://www.brides.com/thmb/ZG_lIownwOgazIuIPBmv9M_FDA4=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/__opt__aboutcom__coeus__resources__content_migration__brides__public__brides-services__production__2016__10__24__580e9b44d1dc137f1593dcfe_2014_bridescom-Editorial_Images-12-Edible-Wedding-Favors-Refresh-Large-Edible-Wedding-Favors-Chocolate-Mousse-Love-Me-Do-Photography-a65883c7a28e40558abecdf1f967144b.jpg"
                                      alt="Product Image"
                                    />
                                  </div>
                                  <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                                ...
                                >
                                  <div className="relative shrink-0">
                                    <img
                                      className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                      src="https://www.thewalletstore.in/cdn/shop/files/9.jpg?v=1737713179&width=1200"
                                      alt="Product Image"
                                    />
                                  </div>
                                  <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                                  ...
                                  <div className="flex justify-center">
                                    ...
                                    >
                                      <div className="relative shrink-0">
                                        <img
                                          className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                          src="https://m.media-amazon.com/images/I/81Vl6qGMspL.jpg"
                                          alt="Product Image"
                                        />
                                      </div>
                                      <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                                  ...
                                  <div className="flex justify-center">
                                    ...
                                    >
                                      <div className="relative shrink-0">
                                        <img
                                          className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                          src="https://ruchoks.com/wp-content/uploads/2024/01/1-84.jpg"
                                          alt="Product Image"
                                        />
                                      </div>
                                      <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                            ...
                            <div
                              id="mega-menu-catalog-tab-11"
                              className="hidden h-full"
                              role="tabpanel"
                              aria-labelledby="mega-menu-catalog-tab-item-11"
                            >
                              {/* {/* <!-- Grid -->  */}
                              <div className="grid grid-cols-3 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-3 md:gap-6">
                                <a
                                ...
                                >
                                  <div className="relative shrink-0">
                                    <img
                                      className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                      src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTVz1A8Ti2O_WJS5dX8B5XdkDDZ6tI_IAkg0g&s"
                                      alt="Product Image"
                                    />
                                  </div>
                                  <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                                ...
                                >
                                  <div className="relative shrink-0">
                                    <img
                                      className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                      src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSyb2JD1Q3RJDenIrbhmPSCs_ovsdW0I2QIeA&s"
                                      alt="Product Image"
                                    />
                                  </div>
                                  <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                                ...
                                >
                                  <div className="relative shrink-0">
                                    <img
                                      className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                      src="https://images-static.naikaa.com/beauty-blog/wp-content/uploads/2024/07/wedding-1.jpg"
                                      alt="Product Image"
                                    />
                                  </div>
                                  <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                                ...
                                >
                                  <div className="relative shrink-0">
                                    <img
                                      className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                      src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQXvN8cq56FEbwqzNfbHgeDcOqfVE7UUr4jVQ&s"
                                      alt="Product Image"
                                    />
                                  </div>
                                  <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                                ...
                                >
                                  <div className="relative shrink-0">
                                    <img
                                      className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                      src="https://i.pinimg.com/564x/ea/34/e8/ea34e8692b950a700a92765a1613c399.jpg"
                                      alt="Product Image"
                                    />
                                  </div>
                                  <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                                ...
                                >
                                  <div className="relative shrink-0">
                                    <img
                                      className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                      src="https://mlw6zuezpssl.i.optimole.com/w:780/h:625/q:mauto/f:avif/https://www.rethespa.in/wp-content/uploads/s12.jpg"
                                      alt="Product Image"
                                    />
                                  </div>
                                  <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                              ...
                              <div
                                id="mega-menu-catalog-tab-13"
                                className="hidden h-full"
                                role="tabpanel"
                                aria-labelledby="mega-menu-catalog-tab-item-13"
                              >
                                <div className="grid grid-cols-3 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-3 md:gap-6">
                                  <a
                                    className="group block p-4 rounded-lg text-center hover:bg-gray-100 focus:outline-hidden focus:bg-gray-100 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800"
                                  ...
                                  >
                                    <div className="relative shrink-0">
                                      <img
                                        className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                        src="https://cdn11.bigcommerce.com/s-9bdyx9g8xs/images/stencil/1280x1280/products/127/1493/sankheda-chairs-complete-set-for-wedding-and-events-rental__62086.1643592082.jpg?c=2"
                                        alt="Product Image"
                                      />
                                    </div>
                                    <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                                  ...
                                  >
                                    <div className="relative shrink-0">
                                      <img
                                        className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                        src="https://sjcaterers.in/wp-content/uploads/2021/06/crockery-rent.jpg"
                                        alt="Product Image"
                                      />
                                    </div>
                                    <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                                  ...
                                  >
                                    <div className="relative shrink-0">
                                      <img
                                        className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                        src="https://encrypted-tbn1.gstatic.com/shopping?q=tbn:ANd9GcRA-A6sE7W3_KngaJV-RVE77zeOldklIDl20y5lvCIRxfGQoHPTbAcPQLfW4QMvMepWWZiURaxho7vh4xE_X-RhiFyOgS_at9dGrTMkiWY"
                                        alt="Product Image"
                                      />
                                    </div>
                                    <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                                    ...
                                    <div className="flex justify-center">
                                      ...
                                      >
                                        <div className="relative shrink-0">
                                          <img
                                            className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                            src="https://encrypted-tbn3.gstatic.com/shopping?q=tbn:ANd9GcSODUDalBMhZ_Ak6GxjVWSB_9b903coKJOhuKX71S2cVSFokuf4RJtPeu4NG3x0lRr5CXTU_Gwt3wCda5lRhrxqTdjKWV_QEz9r7HWW3FU"
                                            alt="Product Image"
                                          />
                                        </div>
                                        <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                                          {" "}
                                          Props & Thematic Decor Items
                                        </span>
                                      </a>
                                    </div>
                                    <div className="flex justify-center">
                                      ...
                                      >
                                        <div className="relative shrink-0">
                                          <img
                                            className="shrink-0 size-16 sm:size-20 lg:size-24 mx-auto object-cover bg-gray-100 rounded-full dark:bg-neutral-800"
                                            src="https://encrypted-tbn2.gstatic.com/shopping?q=tbn:ANd9GcQ_OWIVSE0ErpqsXtMeGc4B725-W2KU2WZGzNvsIW-AFcxCr6dy6Z8iu17sYWOaXF_vSam6NYiOWDZlBzmFB6YaOvluk0oL8dSrLXv5TMd3"
                                            alt="Product Image"
                                          />
                                        </div>
                                        <span className="mt-3 block text-sm text-gray-800 dark:text-neutral-200">
                              ...
                              {/* {/* <!-- Tab -->  */}
                              <div
                                id="mega-menu-catalog-tab-14"
                                className="hidden h-full"
                                role="tabpanel"
                                aria-labelledby="mega-menu-catalog-tab-item-14"
                              >
                                {/* {/* <!-- Loading Indicator -->  */}
                              ...
                              {/* {/* <!-- Tab -->  */}
                              <div
                                id="mega-menu-catalog-tab-15"
                                className="hidden h-full"
                                role="tabpanel"
                                aria-labelledby="mega-menu-catalog-tab-item-15"
                              >
                                {/* {/* <!-- Loading Indicator -->  */}
                                <div className="h-full flex flex-col justify-center items-center text-center">
                                  <span className="py-1.5 inline-flex gap-x-1">
                              ...
                              {/* {/* <!-- Tab -->  */}
                              <div
                                id="mega-menu-catalog-tab-16"
                                className="hidden h-full"
                                role="tabpanel"
                                aria-labelledby="mega-menu-catalog-tab-item-16"
                              >
                                {/* {/* <!-- Loading Indicator -->  */}
                                <div className="h-full flex flex-col justify-center items-center text-center">
                                  <span className="py-1.5 inline-flex gap-x-1">
                              ...
                              {/* {/* <!-- Tab -->  */}
                              <div
                                id="mega-menu-catalog-tab-17"
                                className="hidden h-full"
                                role="tabpanel"
                                aria-labelledby="mega-menu-catalog-tab-item-17"
                              >
                                {/* {/* <!-- Loading Indicator -->  */}
                                <div className="h-full flex flex-col justify-center items-center text-center">
                                  <span className="py-1.5 inline-flex gap-x-1">
                              ...
                              {/* {/* <!-- Tab -->  */}
                              <div
                                id="mega-menu-catalog-tab-18"
                                className="hidden h-full"
                                role="tabpanel"
                                aria-labelledby="mega-menu-catalog-tab-item-18"
                              >
                                {/* {/* <!-- Loading Indicator -->  */}
                                <div className="h-full flex flex-col justify-center items-center text-center">
                                  <span className="py-1.5 inline-flex gap-x-1">
                              ...
                              {/* {/* <!-- Tab -->  */}
                              <div
                                id="mega-menu-catalog-tab-19"
                                className="hidden h-full"
                                role="tabpanel"
                                aria-labelledby="mega-menu-catalog-tab-item-19"
                              >
                                {/* {/* <!-- Loading Indicator -->  */}
                                <div className="h-full flex flex-col justify-center items-center text-center">
                                  <span className="py-1.5 inline-flex gap-x-1">
                  ...
                  <div className="hidden md:block w-full">
                    ...
                    <div className="relative w-full">
                      ...
                      <div className="absolute inset-y-0 end-0 z-10 flex items-center pe-1 sm:pe-1.5">
                        <button
                          type="button"
                          className="inline-flex shrink-0 justify-center items-center w-10 h-8 rounded-full bg-emerald-600 text-white hover:bg-emerald-700 focus:outline-hidden focus:bg-emerald-700 dark:bg-emerald-500 dark:hover:bg-emerald-600 dark:focus:bg-emerald-600"
                        >
                          <svg
                      ...
                      <div className="hidden absolute inset-y-0 end-12 flex items-center pointer-events-none z-10 pe-1">
                        <button
                          type="button"
                          className="inline-flex shrink-0 justify-center items-center size-6 rounded-full text-gray-500 hover:text-emerald-600 focus:outline-hidden focus:text-emerald-600 dark:text-neutral-500 dark:hover:text-emerald-500 dark:focus:text-emerald-500"
                          aria-label="Close"
                        >
              ...
              <div className="order-2 md:order-3 ms-auto lg:ms-0">
                <div className="flex justify-end items-center gap-x-2">
                  {/* <!-- Account Button Icon --> */}
                  <a
                    className="flex flex-col justify-center items-center gap-1 min-w-14 min-h-8 text-xs rounded-full text-gray-800 hover:text-emerald-600 focus:outline-hidden focus:text-emerald-600 dark:text-neutral-200 dark:hover:text-neutral-400 dark:focus:text-neutral-400"
                    href="#"
                  >
                    <img
                  ...
                  {/* <!-- Cart Button Icon --> */}
                  <a
                    className="relative flex flex-col justify-center items-center gap-1 min-w-14 min-h-8 text-xs rounded-full text-gray-800 hover:text-emerald-600 focus:outline-hidden focus:text-emerald-600 dark:text-neutral-200 dark:hover:text-neutral-400 dark:focus:text-neutral-400"
                    href="#"
                  >
                    <svg
                      className="shrink-0 size-4 text-gray-800 dark:text-neutral-200"
                    ...
                    <li className="flex items-center truncate">
                      ...
                      >
                        <span className="truncate">
                          {" "}
                          {venueData?.subcategory_details?.name}
                        </span>
                      </a>
                      <svg
                        className="shrink-0 overflow-visible size-4  text-gray-400 dark:text-neutral-600"
      ...
      "
                    ...
                    <div className="pt-14 pb-10">
                      ...
                      <div className="mt-10">
                         ...
                         */}
                        <p className="mt-3 text-sm text-gray-800 dark:text-neutral-200">
                          {venueData?.name} is a beautifull area to host all
                          your functions, from pre-wedding ceremonies. The
                          abundance of establishments offered by them is
                          mentioned below:
                        </p>
                          ...
                          <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
                            ...
                            <div className="max-w-5xl mx-auto">
                              <div className="hs-accordion-group divide-y divide-gray-200 dark:divide-neutral-800">
                                {venueData?.faq_details &&
                                  venueData.faq_details.map((faq, index) => (
                                    <div
                                      className="hs-accordion pb-3" // 'active' for default open, remove if all should be closed initially
                              ...
                              <div className="p-5">
                                ...
                                <div className="flex flex-wrap justify-between items-center gap-1">
                                  ...
                                  <div>
                                    <FavoriteButton
                                      initialFavorite={
                                        venueData?.favorite_details?.is_favorite
                                      }
                                      contentType={
                                        venueData?.favorite_details
                                          ?.content_type
                                      }
                                    ...
                                    <div className="mt-1.5 flex flex-col gap-y-0.5">
                                      ...
                                      <div className="flex items-center gap-x-1">
                                        ...
                                        <div>
                                          {venueData?.services_offered_details && (
                                            <>
                                              {venueData.services_offered_details.some(
                                                (service) =>
                                                  service.name ===
                                                  "is_veg_available"
                                              ) &&
                                                venueData.services_offered_details.some(
                                                  (service) =>
                                                    service.name ===
                                                    "is_non_veg_available"
                                                ) && (
                                                  <button
                                                    type="button"
                                                    className="flex items-center gap-x-1 text-start font-medium text-sm text-emerald-600 underline-offset-4 hover:underline focus:outline-hidden focus:underline dark:text-neutral-200 dark:hover:text-neutral-300 dark:focus:text-neutral-300"
                                                  >
                                                    Veg & Non-veg
                                                  </button>
                                                )}
                                  ...
                                  <div className="grow">
                                    ...
                                    <div className="mt-1.5">
                                      <p className="text-sm text-gray-800 dark:text-neutral-200">
                                        {venueData?.name} can accommodate upto{" "}
                                        {venueData?.guest_capacity} guests,
                                        making it perfect for both intimate
      ...
      >
        Choose Location
          ...
          <div
            ...
            role="dialog"
            tabIndex="-1"
            aria-labelledby="hs-pro-shmnrsm-label"
          >
                  ...
                  >
                    <span className="flex gap-x-2.5">
                      ...
                      <span className="grow -mt-0.5">
                        ...
                        <span className="block text-sm/6 text-gray-500 dark:text-neutral-500">
                          Im Wiegenfeld 4 85570 Markt Schwaben, Markt Schwaben
                          85570
                        </span>
                      </span>
                    </span>
                  ...
                  <div className="px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center gap-x-3">
                      ...
                      <div className="grow">
                        ...
                        >
                          Google Pixel Tablet - 11-Inch Tablet, 8 GB RAM - 128
                          GB, Porcelain | Android Tablet, Extra-Long Battery
                          Life
                        </h4>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        ...
                        >
                          ...
                          {/* Label */}
                          <span className="truncate leading-none">Pro</span>
                        </label>
