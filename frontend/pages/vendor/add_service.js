...
export default function AddProduct() {
      ...
      const actions = [
        {
          ...
          fn: () => editorInstance.current.chain().focus().toggleBold().run()
        },
        {
          id: '[data-hs-editor-italic]',
          fn: () => editorInstance.current.chain().focus().toggleItalic().run()
        },
        {
          id: '[data-hs-editor-underline]',
          fn: () => editorInstance.current.chain().focus().toggleUnderline().run()
        },
        {
          id: '[data-hs-editor-strike]',
          fn: () => editorInstance.current.chain().focus().toggleStrike().run()
        },
        {
        ...
        },
        {
          ...
          fn: () => editorInstance.current.chain().focus().toggleOrderedList().run()
        },
        {
          id: '[data-hs-editor-ul]',
          fn: () => editorInstance.current.chain().focus().toggleBulletList().run()
        },
        {
          id: '[data-hs-editor-blockquote]',
          fn: () => editorInstance.current.chain().focus().toggleBlockquote().run()
        },
        {
          id: '[data-hs-editor-code]',
          fn: () => editorInstance.current.chain().focus().toggleCode().run()
        }
      ];
            ...
            <div className="max-w-[85rem] flex justify-between lg:grid lg:grid-cols-3 basis-full items-center w-full mx-auto py-2.5 px-4 sm:px-6 lg:px-8">
              ...
              <div className="flex items-center">
                <div className="hidden sm:block">
                  ...
                  {/* Full SVG Logo from original with fill and stroke classnames */}
  ...
  <div className="hs-dropdown [--placement:top-right] [--strategy:absolute] [--auto-close:inside] relative inline-flex">
    ...
    >
      <img
        className="shrink-0 size-9.5 lg:size-8 rounded-full"
...
{/* End Link */}
    ...
    <main id="content" className="pb-14 sm:pb-16">
            ...
            <div className="lg:col-span-4 space-y-4">
              ...
              <div className="flex flex-col bg-white border border-stone-200 overflow-hidden rounded-xl shadow-2xs dark:bg-neutral-800 dark:border-neutral-700">
                ...
                <div className="p-5 space-y-4">
                  ...
                  {/* Input */}
                  <div>
                    <label htmlFor="hs-pro-eapnm" className="block mb-2 text-sm font-medium text-stone-800 dark:text-neutral-200">
                      Name
                    ...
                    <input id="hs-pro-eapnm" type="text" className="py-1.5 sm:py-2 px-3 block w-full border border-stone-200 rounded-lg sm:text-sm text-stone-800 placeholder:text-stone-500 focus:z-10 focus:border-green-600 focus:ring-green-600 dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-200 dark:placeholder:text-neutral-500 dark:focus:outline-hidden dark:focus:ring-1 dark:focus:ring-neutral-600" placeholder="MG Mahal Resorts.." defaultValue="" />
                  </div>
                  {/* End Input */}
                  ...
                  <div className="grid sm:grid-cols-2 gap-3 sm:gap-5">
                    {/* Input */}
                    <div>
                      <label htmlFor="hs-pro-eapsku" className="block mb-2 text-sm font-medium text-stone-800 dark:text-neutral-200">
                        Contact Number
                      </label>
                      <input id="hs-pro-eapsku" type="text" className="py-1.5 sm:py-2 px-3 block w-full border border-stone-200 rounded-lg sm:text-sm text-stone-800 placeholder:text-stone-500 focus:z-10 focus:border-green-600 focus:ring-green-600 dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-200 dark:placeholder:text-neutral-500 dark:focus:outline-hidden dark:focus:ring-1 dark:focus:ring-neutral-600" placeholder="987XXXXX90" defaultValue="" />
                    </div>
                    {/* End Input */}

                    {/* Input */}
                    <div>
                      <label htmlFor="hs-pro-eapwe" className="block mb-2 text-sm font-medium text-stone-800 dark:text-neutral-200">
                        Email Address
                      </label>
                      <div className="relative w-full">
                        <input id="hs-pro-eapwe" type="text" className="py-1.5 sm:py-2 px-3 block w-full border border-stone-200 rounded-lg sm:text-sm text-stone-800 placeholder:text-stone-500 focus:z-10 focus:border-green-600 focus:ring-green-600 dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-200 dark:placeholder:text-neutral-500 dark:focus:outline-hidden dark:focus:ring-1 dark:focus:ring-neutral-600" placeholder="mahal@email.com" defaultValue="" />
                      </div>
                    </div>
                    {/* End Input */}
                  </div>
                    ...
                    <div className="bg-white border border-stone-200 rounded-xl overflow-hidden dark:bg-neutral-800 dark:border-neutral-700">
                      <div id="hs-editor-tiptap">
                        <div className="sticky top-0 bg-white flex align-middle gap-x-0.5 border-b border-stone-200 p-2 dark:bg-neutral-800 dark:border-neutral-700">
                          <button className="size-8 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent text-stone-800 hover:bg-stone-100 disabled:opacity-50 disabled:pointer-events-none focus:outline-hidden focus:bg-stone-100 dark:text-white dark:hover:bg-neutral-700 dark:focus:bg-neutral-700" type="button" data-hs-editor-bold>
                            <svg className="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                              <path d="M14 12a4 4 0 0 0 0-8H6v8" />
                              <path d="M15 20a4 4 0 0 0 0-8H6v8Z" />
                            </svg>
                          </button>
                          <button className="size-8 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent text-stone-800 hover:bg-stone-100 disabled:opacity-50 disabled:pointer-events-none focus:outline-hidden focus:bg-stone-100 dark:text-white dark:hover:bg-neutral-700 dark:focus:bg-neutral-700" type="button" data-hs-editor-italic>
                            <svg className="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                          ...
                          <button className="size-8 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent text-stone-800 hover:bg-stone-100 disabled:opacity-50 disabled:pointer-events-none focus:outline-hidden focus:bg-stone-100 dark:text-white dark:hover:bg-neutral-700 dark:focus:bg-neutral-700" type="button" data-hs-editor-underline>
                            <svg className="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                              <path d="M6 4v6a6 6 0 0 0 12 0V4" />
                              <line x1="4" x2="20" y1="20" y2="20" />
                            </svg>
                          </button>
                          <button className="size-8 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent text-stone-800 hover:bg-stone-100 disabled:opacity-50 disabled:pointer-events-none focus:outline-hidden focus:bg-stone-100 dark:text-white dark:hover:bg-neutral-700 dark:focus:bg-neutral-700" type="button" data-hs-editor-strike>
                            <svg className="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                          ...
                          <button className="size-8 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent text-stone-800 hover:bg-stone-100 disabled:opacity-50 disabled:pointer-events-none focus:outline-hidden focus:bg-stone-100 dark:text-white dark:hover:bg-neutral-700 dark:focus:bg-neutral-700" type="button" data-hs-editor-link>
                            <svg className="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                              <path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71" />
                              <path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71" />
                            </svg>
                          </button>
                          <button className="size-8 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent text-stone-800 hover:bg-stone-100 disabled:opacity-50 disabled:pointer-events-none focus:outline-hidden focus:bg-stone-100 dark:text-white dark:hover:bg-neutral-700 dark:focus:bg-neutral-700" type="button" data-hs-editor-ol>
                            <svg className="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                          ...
                          <button className="size-8 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent text-stone-800 hover:bg-stone-100 disabled:opacity-50 disabled:pointer-events-none focus:outline-hidden focus:bg-stone-100 dark:text-white dark:hover:bg-neutral-700 dark:focus:bg-neutral-700" type="button" data-hs-editor-ul>
                            <svg className="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                          ...
                          <button className="size-8 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent text-stone-800 hover:bg-stone-100 disabled:opacity-50 disabled:pointer-events-none focus:outline-hidden focus:bg-stone-100 dark:text-white dark:hover:bg-neutral-700 dark:focus:bg-neutral-700" type="button" data-hs-editor-blockquote>
                            <svg className="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                              <path d="M17 6H3" />
                              <path d="M21 12H8" />
                              <path d="M21 18H8" />
                          ...
                          <button className="size-8 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent text-stone-800 hover:bg-stone-100 disabled:opacity-50 disabled:pointer-events-none focus:outline-hidden focus:bg-stone-100 dark:text-white dark:hover:bg-neutral-700 dark:focus:bg-neutral-700" type="button" data-hs-editor-code>
                            <svg className="shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <div className="flex flex-col bg-white border border-stone-200 overflow-hidden rounded-xl shadow-2xs dark:bg-neutral-800 dark:border-neutral-700">
                ...
                <div className="flex flex-wrap gap-4 p-4">
                  <label htmlFor="hs-pro-pytfmty-1" className="py-2 px-2.5 relative flex justify-center items-center text-center text-[13px] bg-white border border-gray-200 ring-1 ring-transparent text-gray-800 cursor-pointer rounded-xl hover:border-green-600 hover:ring-green-600 dark:bg-neutral-800 dark:text-neutral-200 dark:border-neutral-700 dark:hover:ring-neutral-600 dark:hover:ring-neutral-600 has-checked:bg-green-100 has-checked:border-green-200 has-checked:ring-green-200 has-checked:text-green-800 dark:has-checked:bg-green-800/30 dark:has-checked:border-green-800/50 dark:has-checked:ring-green-800/50 dark:has-checked:text-green-500 has-disabled:pointer-events-none has-disabled:text-gray-200 dark:has-disabled:text-neutral-700">
                    <input type="checkbox" id="hs-pro-pytfmty-1" className="hidden peer" name="hs-pro-pytfmty" />
                  ...
                  <label htmlFor="hs-pro-pytfmty-2" className="py-2 px-2.5 relative flex justify-center items-center text-center text-[13px] bg-white border border-gray-200 ring-1 ring-transparent text-gray-800 cursor-pointer rounded-xl hover:border-green-600 hover:ring-green-600 dark:bg-neutral-800 dark:text-neutral-200 dark:border-neutral-700 dark:hover:ring-neutral-600 dark:hover:ring-neutral-600 has-checked:bg-green-100 has-checked:border-green-200 has-checked:ring-green-200 has-checked:text-green-800 dark:has-checked:bg-green-800/30 dark:has-checked:border-green-800/50 dark:has-checked:ring-green-800/50 dark:has-checked:text-green-500 has-disabled:pointer-events-none has-disabled:text-gray-200 dark:has-disabled:text-neutral-700">
                    <input type="checkbox" id="hs-pro-pytfmty-2" className="hidden peer" name="hs-pro-pytfmty" />
                    <span className="flex shrink-0 justify-center items-center size-0 bg-green-500 text-transparent rounded-full transition-all duration-200 peer-checked:size-4 peer-checked:me-1.5 peer-checked:text-white">
                      <svg className="shrink-0 size-2.5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round">
                        <path d="M20 6 9 17l-5-5" />
                      </svg>
                  ...
                  <label htmlFor="hs-pro-pytfmty-3" className="py-2 px-2.5 relative flex justify-center items-center text-center text-[13px] bg-white border border-gray-200 ring-1 ring-transparent text-gray-800 cursor-pointer rounded-xl hover:border-green-600 hover:ring-green-600 dark:bg-neutral-800 dark:text-neutral-200 dark:border-neutral-700 dark:hover:ring-neutral-600 dark:hover:ring-neutral-600 has-checked:bg-green-100 has-checked:border-green-200 has-checked:ring-green-200 has-checked:text-green-800 dark:has-checked:bg-green-800/30 dark:has-checked:border-green-800/50 dark:has-checked:ring-green-800/50 dark:has-checked:text-green-500 has-disabled:pointer-events-none has-disabled:text-gray-200 dark:has-disabled:text-neutral-700">
                    <input type="checkbox" id="hs-pro-pytfmty-3" className="hidden peer" name="hs-pro-pytfmty" />
                    <span className="flex shrink-0 justify-center items-center size-0 bg-green-500 text-transparent rounded-full transition-all duration-200 peer-checked:size-4 peer-checked:me-1.5 peer-checked:text-white">
                      <svg className="shrink-0 size-2.5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round">
                        <path d="M20 6 9 17l-5-5" />
                      </svg>
                  ...
                  <label htmlFor="hs-pro-pytfmty-4" className="py-2 px-2.5 relative flex justify-center items-center text-center text-[13px] bg-white border border-gray-200 ring-1 ring-transparent text-gray-800 cursor-pointer rounded-xl hover:border-green-600 hover:ring-green-600 dark:bg-neutral-800 dark:text-neutral-200 dark:border-neutral-700 dark:hover:ring-neutral-600 dark:hover:ring-neutral-600 has-checked:bg-green-100 has-checked:border-green-200 has-checked:ring-green-200 has-checked:text-green-800 dark:has-checked:bg-green-800/30 dark:has-checked:border-green-800/50 dark:has-checked:ring-green-800/50 dark:has-checked:text-green-500 has-disabled:pointer-events-none has-disabled:text-gray-200 dark:has-disabled:text-neutral-700">
                    <input type="checkbox" id="hs-pro-pytfmty-4" className="hidden peer" name="hs-pro-pytfmty" />
                    <span className="flex shrink-0 justify-center items-center size-0 bg-green-500 text-transparent rounded-full transition-all duration-200 peer-checked:size-4 peer-checked:me-1.5 peer-checked:text-white">
                      <svg className="shrink-0 size-2.5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round">
                        <path d="M20 6 9 17l-5-5" />
                      </svg>
                  ...
                  <label htmlFor="hs-pro-pytfmty-5" className="py-2 px-2.5 relative flex justify-center items-center text-center text-[13px] bg-white border border-gray-200 ring-1 ring-transparent text-gray-800 cursor-pointer rounded-xl hover:border-green-600 hover:ring-green-600 dark:bg-neutral-800 dark:text-neutral-200 dark:border-neutral-700 dark:hover:ring-neutral-600 dark:hover:ring-neutral-600 has-checked:bg-green-100 has-checked:border-green-200 has-checked:ring-green-200 has-checked:text-green-800 dark:has-checked:bg-green-800/30 dark:has-checked:border-green-800/50 dark:has-checked:ring-green-800/50 dark:has-checked:text-green-500 has-disabled:pointer-events-none has-disabled:text-gray-200 dark:has-disabled:text-neutral-700">
                    <input type="checkbox" id="hs-pro-pytfmty-5" className="hidden peer" name="hs-pro-pytfmty" />
                    <span className="flex shrink-0 justify-center items-center size-0 bg-green-500 text-transparent rounded-full transition-all duration-200 peer-checked:size-4 peer-checked:me-1.5 peer-checked:text-white">
                      <svg className="shrink-0 size-2.5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round">
                        <path d="M20 6 9 17l-5-5" />
                      </svg>
                  ...
                  <label htmlFor="hs-pro-pytfmty-6" className="py-2 px-2.5 relative flex justify-center items-center text-center text-[13px] bg-white border border-gray-200 ring-1 ring-transparent text-gray-800 cursor-pointer rounded-xl hover:border-green-600 hover:ring-green-600 dark:bg-neutral-800 dark:text-neutral-200 dark:border-neutral-700 dark:hover:ring-neutral-600 dark:hover:ring-neutral-600 has-checked:bg-green-100 has-checked:border-green-200 has-checked:ring-green-200 has-checked:text-green-800 dark:has-checked:bg-green-800/30 dark:has-checked:border-green-800/50 dark:has-checked:ring-green-800/50 dark:has-checked:text-green-500 has-disabled:pointer-events-none has-disabled:text-gray-200 dark:has-disabled:text-neutral-700">
                    <input type="checkbox" id="hs-pro-pytfmty-6" className="hidden peer" name="hs-pro-pytfmty" />
                    <span className="flex shrink-0 justify-center items-center size-0 bg-green-500 text-transparent rounded-full transition-all duration-200 peer-checked:size-4 peer-checked:me-1.5 peer-checked:text-white">
                      <svg className="shrink-0 size-2.5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round">
                        <path d="M20 6 9 17l-5-5" />
                      </svg>
                  ...
                  <label htmlFor="hs-pro-pytfmty-7" className="py-2 px-2.5 relative flex justify-center items-center text-center text-[13px] bg-white border border-gray-200 ring-1 ring-transparent text-gray-800 cursor-pointer rounded-xl hover:border-green-600 hover:ring-green-600 dark:bg-neutral-800 dark:text-neutral-200 dark:border-neutral-700 dark:hover:ring-neutral-600 dark:hover:ring-neutral-600 has-checked:bg-green-100 has-checked:border-green-200 has-checked:ring-green-200 has-checked:text-green-800 dark:has-checked:bg-green-800/30 dark:has-checked:border-green-800/50 dark:has-checked:ring-green-800/50 dark:has-checked:text-green-500 has-disabled:pointer-events-none has-disabled:text-gray-200 dark:has-disabled:text-neutral-700">
                    <input type="checkbox" id="hs-pro-pytfmty-7" className="hidden peer" name="hs-pro-pytfmty" />
                    <span className="flex shrink-0 justify-center items-center size-0 bg-green-500 text-transparent rounded-full transition-all duration-200 peer-checked:size-4 peer-checked:me-1.5 peer-checked:text-white">
                      <svg className="shrink-0 size-2.5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round">
                        <path d="M20 6 9 17l-5-5" />
                      </svg>
                  ...
                  <label htmlFor="hs-pro-pytfmty-8" className="py-2 px-2.5 relative flex justify-center items-center text-center text-[13px] bg-white border border-gray-200 ring-1 ring-transparent text-gray-800 cursor-pointer rounded-xl hover:border-green-600 hover:ring-green-600 dark:bg-neutral-800 dark:text-neutral-200 dark:border-neutral-700 dark:hover:ring-neutral-600 dark:hover:ring-neutral-600 has-checked:bg-green-100 has-checked:border-green-200 has-checked:ring-green-200 has-checked:text-green-800 dark:has-checked:bg-green-800/30 dark:has-checked:border-green-800/50 dark:has-checked:ring-green-800/50 dark:has-checked:text-green-500 has-disabled:pointer-events-none has-disabled:text-gray-200 dark:has-disabled:text-neutral-700">
                    <input type="checkbox" id="hs-pro-pytfmty-8" className="hidden peer" name="hs-pro-pytfmty" />
                    <span className="flex shrink-0 justify-center items-center size-0 bg-green-500 text-transparent rounded-full transition-all duration-200 peer-checked:size-4 peer-checked:me-1.5 peer-checked:text-white">
                      <svg className="shrink-0 size-2.5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round">
                        <path d="M20 6 9 17l-5-5" />
                      </svg>
              ...
              <div className="lg:sticky lg:top-5 space-y-4">
                ...
                <div className="flex flex-col bg-white border border-stone-200 overflow-hidden rounded-xl shadow-2xs dark:bg-neutral-800 dark:border-neutral-700">
                  ...
                  <div id="hs-product-details-pricing-card-body" className="p-5 space-y-4">
                    {/* Input */}
                    <div>
                      <label htmlFor="hs-pro-daufpr" className="block mb-2 text-sm font-medium text-stone-800 dark:text-neutral-200">
                        Price
                      </label>
                      <div className="relative w-full">
                        ...
                        <div className="absolute inset-y-0 end-0 flex items-center pe-[5px] text-stone-400">
                          ...
                          <div className="relative">
                            <select data-hs-select='{
                                ...
                                "dropdownClasses": "end-0 mt-2 p-1 z-50 w-24 space-y-0.5 bg-white rounded-xl shadow-xl dark:bg-neutral-950",
                              ...
                              <option selected value="USD">INR</option>
                              <option value="EURO">EURO</option>
                              <option value="YUAN">YUAN</option>
                            </select>

                            <div className="absolute top-1/2 end-1.5 -translate-y-1/2">
                              <svg className="shrink-0 size-3.5 text-stone-600 dark:text-neutral-400" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                <path d="m6 9 6 6 6-6" />
                              </svg>
                            </div>
                          </div>
                ...
                <div className="flex flex-col bg-white border border-stone-200 overflow-hidden rounded-xl shadow-2xs dark:bg-neutral-800 dark:border-neutral-700">
                  ...
                  <div id="hs-add-product-organization-card-body" className="p-5 space-y-4">
                    {/* Input */}
                    <div>
                      <label htmlFor="hs-pro-daufvd" className="block mb-2 text-sm font-medium text-stone-800 dark:text-neutral-200">
                        Capacity
                      </label>
                      <input id="hs-pro-daufvd" type="text" className="py-1.5 sm:py-2 px-3 block w-full border border-stone-200 rounded-lg sm:text-sm text-stone-800 placeholder:text-stone-500 focus:z-10 focus:border-green-600 focus:ring-green-600 dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-200 dark:placeholder:text-neutral-500 dark:focus:outline-hidden dark:focus:ring-1 dark:focus:ring-neutral-600" placeholder="eg. 450" />
                    </div>
                    {/* End Input */}
                    ...
                    <div>
                      ...
                      <div className="relative">
                        {/* Fixed Category Display with Same Styling */}
                        <div className="hs-select-disabled:pointer-events-none hs-select-disabled:opacity-50 relative py-1.5 sm:py-2 px-4 pe-9 flex text-nowrap w-full cursor-default bg-white border border-stone-200 rounded-lg text-start sm:text-sm text-stone-800 dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-200">
                          <span className="truncate">Banquet Halls</span>
                        </div>
                      </div>
                      {/* End Select */}
                    </div>
                    ...
                    {/* Location Section */}
                    <div className="mt-4">
                      <label htmlFor="location-input" className="block mb-2 text-sm font-medium text-stone-800 dark:text-neutral-200">
                        Location
                      </label>
                      ...
                      <div className="relative">
                        ...
                        <button type="button" className="absolute inset-y-0 right-2 flex items-center justify-center">
            ...
            <div className="fixed bottom-0 start-1/2 -translate-x-1/2 p-6 z-50 w-full max-w-md mx-auto hs-removing:translate-y-5 hs-removing:opacity-0 transition duration-300">
              <div className="py-2 ps-5 pe-2 bg-stone-800 rounded-full shadow-md dark:bg-neutral-950">
                <div className="flex justify-between items-center gap-x-3">
                  <Link href="#" className="text-red-400 decoration-2 font-medium text-sm hover:underline focus:outline-hidden focus:underline dark:text-red-500">
                    Delete
                  </Link>

                  <div className="inline-flex items-center gap-x-2">
                    <Link href="#" className="text-stone-300 decoration-2 font-medium text-sm hover:underline focus:outline-hidden focus:underline dark:text-neutral-400">
                      Cancel
                    </Link>
                    <div className="w-px h-4 bg-stone-700 dark:bg-neutral-700"></div>
                    <Link href="#" className="text-green-400 decoration-2 font-medium text-sm hover:underline focus:outline-hidden focus:underline dark:text-green-500">
                      Save changes
                    </Link>
      ...
      {/* Scripts */}
      <Script src="../assets/vendor/preline/dist/index.js?v=3.1.0" strategy="lazyOnload" />
      <Script src="../assets/vendor/clipboard/dist/clipboard.min.js" strategy="lazyOnload" />
      <Script src="../assets/js/hs-copy-clipboard-helper.js" strategy="lazyOnload" />
        ...
        {`
          (function () {
            window.addEventListener('load', () => {
              const copyMarkupEl = HSCopyMarkup.getInstance('#copy-markup');

              copyMarkupEl.on('copy', (el) => {
                const currentQty = copyMarkupEl.items.length;
                const labels = el.querySelectorAll('label');
                const inputs = el.querySelectorAll('input');
                const disabledDeleteBtn = copyMarkupEl.wrapper.querySelector('[data-hs-copy-markup-delete-item].disabled');
                ...
                labels.forEach((label) => {
                  ...
                  input.setAttribute('id', newIdentifier);
                });
              ...
              copyMarkupEl.on('delete', (el) => {
                const currentQty = copyMarkupEl.items.length;

                if (currentQty === 1) {
                  const deleteBtn = copyMarkupEl.items[0].querySelector('[data-hs-copy-markup-delete-item]');
