                  ...
                  <div className="flex flex-col bg-white border border-stone-200 overflow-hidden rounded-xl shadow-2xs dark:bg-neutral-800 dark:border-neutral-700">
                    ...
                    <div className="p-5 space-y-4">
                      ...
                      <div className="grid sm:grid-cols-2 gap-3 sm:gap-5">
                        <FormInput id="ServiceName" label="Name" placeholder="ABC Miscellaneous Services" value={Name} onChange={(e) => setName(e.target.value)} required />
                      ...
                      <div className="grid sm:grid-cols-2 gap-3 sm:gap-5">
                        ...
                        <FormInput id="emailAddress" label="Email Address" type="email" placeholder="abcmisc@email.com" value={emailAddress} onChange={(e) => setEmailAddress(e.target.value)} />
                      </div>
                      <div className="grid sm:grid-cols-2 gap-3 sm:gap-5">
                        <FormInput
                ...
                <div className="lg:col-span-2">
                  <div className="lg:sticky lg:top-5 space-y-4">
                    <div className="flex flex-col bg-white border border-stone-200 overflow-hidden rounded-xl shadow-2xs dark:bg-neutral-800 dark:border-neutral-700">
                      ...
                      <div className="p-5 space-y-4">
                        <FormInput id="startingPrice" label="Starting Price" type="number" placeholder="Enter starting price" value={startingPrice} onChange={(e) => setStartingPrice(e.target.value)} />
